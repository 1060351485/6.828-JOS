...
sleep(int sec)
{
  ...
  80003e:	e8 1e 0e 00 00       	call   800e61 <sys_time_msec>
	unsigned end = now + sec * 1000;

	if ((int)now < 0 && (int)now > -MAXERROR)
  800043:	85 c0                	test   %eax,%eax
  800045:	79 25                	jns    80006c <sleep+0x38>
  800047:	83 f8 ef             	cmp    $0xffffffef,%eax
  80004a:	7c 20                	jl     80006c <sleep+0x38>
		panic("sys_time_msec: %e", (int)now);
  80004c:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800050:	c7 44 24 08 40 11 80 	movl   $0x801140,0x8(%esp)
  800057:	00 
  800058:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  80005f:	00 
  800060:	c7 04 24 52 11 80 00 	movl   $0x801152,(%esp)
  800067:	e8 f8 00 00 00       	call   800164 <_panic>
...
sleep(int sec)
{
  ...
  80007a:	76 21                	jbe    80009d <sleep+0x69>
		panic("sleep: wrap");
  80007c:	c7 44 24 08 62 11 80 	movl   $0x801162,0x8(%esp)
  800083:	00 
  800084:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  80008b:	00 
  80008c:	c7 04 24 52 11 80 00 	movl   $0x801152,(%esp)
  800093:	e8 cc 00 00 00       	call   800164 <_panic>

	while (sys_time_msec() < end)
		sys_yield();
  800098:	e8 3d 0b 00 00       	call   800bda <sys_yield>
	if ((int)now < 0 && (int)now > -MAXERROR)
		panic("sys_time_msec: %e", (int)now);
	if (end < now)
		panic("sleep: wrap");
	...
	while (sys_time_msec() < end)
  80009d:	e8 bf 0d 00 00       	call   800e61 <sys_time_msec>
...
umain(int argc, char **argv)
{
  ...
  8000b3:	bb 32 00 00 00       	mov    $0x32,%ebx
	...
	for (i = 0; i < 50; i++)
		sys_yield();
  8000b8:	e8 1d 0b 00 00       	call   800bda <sys_yield>
umain(int argc, char **argv)
{
	int i;
  ...
  8000c0:	c7 04 24 6e 11 80 00 	movl   $0x80116e,(%esp)
  8000c7:	e8 90 01 00 00       	call   80025c <cprintf>
	for (i = 5; i >= 0; i--) {
  8000cc:	bb 05 00 00 00       	mov    $0x5,%ebx
		cprintf("%d ", i);
  8000d1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8000d5:	c7 04 24 84 11 80 00 	movl   $0x801184,(%esp)
  8000dc:	e8 7b 01 00 00       	call   80025c <cprintf>
		sleep(1);
  ...
  8000f1:	75 de                	jne    8000d1 <umain+0x25>
	...
	cprintf("\n");
  8000f3:	c7 04 24 88 11 80 00 	movl   $0x801188,(%esp)
  8000fa:	e8 5d 01 00 00       	call   80025c <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  800116:	e8 a0 0a 00 00       	call   800bbb <sys_getenvid>
  ...
  80013f:	e8 68 ff ff ff       	call   8000ac <umain>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800190:	c7 04 24 94 11 80 00 	movl   $0x801194,(%esp)
  ...
  8001a6:	e8 50 00 00 00       	call   8001fb <vcprintf>
	cprintf("\n");
  8001ab:	c7 04 24 88 11 80 00 	movl   $0x801188,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d1:	e8 0e 0c 00 00       	call   800ee4 <__udivdi3>
  ...
  800324:	e8 db 0c 00 00       	call   801004 <__umoddi3>
  800329:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80032d:	0f be 80 b7 11 80 00 	movsbl 0x8011b7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800448:	ff 24 95 00 13 80 00 	jmp    *0x801300(,%edx,4)
  ...
  800508:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  80050f:	00 
  ...
  80053c:	75 05                	jne    800543 <vprintfmt+0x185>
				p = "(null)";
  80053e:	be c8 11 80 00       	mov    $0x8011c8,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b96:	00 
  800b97:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800b9e:	00 
  800b9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba6:	00 
  800ba7:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c28:	00 
  800c29:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800c30:	00 
  800c31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c38:	00 
  800c39:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c7b:	00 
  800c7c:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800c83:	00 
  800c84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c8b:	00 
  800c8c:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cce:	00 
  800ccf:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800cd6:	00 
  800cd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cde:	00 
  800cdf:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d21:	00 
  800d22:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800d29:	00 
  800d2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d31:	00 
  800d32:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d67:	7e 28                	jle    800d91 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dba:	7e 28                	jle    800de4 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800dbc:	89 44 24 10          	mov    %eax,0x10(%esp)
  800dc0:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800dc7:	00 
  ...
  800ddf:	e8 80 f3 ff ff       	call   800164 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e2f:	7e 28                	jle    800e59 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800e31:	89 44 24 10          	mov    %eax,0x10(%esp)
  800e35:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800e3c:	00 
  800e3d:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800e44:	00 
  800e45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4c:	00 
  800e4d:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
  800e54:	e8 0b f3 ff ff       	call   800164 <_panic>
...
sys_e1000_receive(char* pck, size_t* length){
  ...
  800eac:	b8 0f 00 00 00       	mov    $0xf,%eax
...
sys_e1000_get_mac(uint8_t* mac_addr){
  ...
  800ecd:	b8 11 00 00 00       	mov    $0x11,%eax
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800eee:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800ef6:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800efa:	89 cd                	mov    %ecx,%ebp
  800efc:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800f02:	75 2c                	jne    800f30 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800f04:	39 f9                	cmp    %edi,%ecx
  800f06:	77 68                	ja     800f70 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800f0a:	75 0b                	jne    800f17 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f32:	77 2c                	ja     800f60 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800f34:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800f37:	83 f6 1f             	xor    $0x1f,%esi
  800f3a:	75 4c                	jne    800f88 <__udivdi3+0xa4>
  ...
  800f3e:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800f43:	72 0a                	jb     800f4f <__udivdi3+0x6b>
  800f45:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800f49:	0f 87 ad 00 00 00    	ja     800ffc <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f4f:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f95:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800f97:	89 ea                	mov    %ebp,%edx
  800f99:	88 c1                	mov    %al,%cl
  800f9b:	d3 ea                	shr    %cl,%edx
  800f9d:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800fa1:	09 ca                	or     %ecx,%edx
  800fa3:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800fa7:	89 f1                	mov    %esi,%ecx
  800fa9:	d3 e5                	shl    %cl,%ebp
  800fab:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800faf:	89 fd                	mov    %edi,%ebp
  800fb1:	88 c1                	mov    %al,%cl
  800fb3:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800fb5:	89 fa                	mov    %edi,%edx
  800fb7:	89 f1                	mov    %esi,%ecx
  800fb9:	d3 e2                	shl    %cl,%edx
  800fbb:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800fbf:	88 c1                	mov    %al,%cl
  800fc1:	d3 ef                	shr    %cl,%edi
  800fc3:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800fc5:	89 f8                	mov    %edi,%eax
  800fc7:	89 ea                	mov    %ebp,%edx
  800fc9:	f7 74 24 08          	divl   0x8(%esp)
  ...
  800fd5:	39 d1                	cmp    %edx,%ecx
  800fd7:	72 17                	jb     800ff0 <__udivdi3+0x10c>
  800fd9:	74 09                	je     800fe4 <__udivdi3+0x100>
  800fdb:	89 fe                	mov    %edi,%esi
  800fdd:	31 ff                	xor    %edi,%edi
  800fdf:	e9 41 ff ff ff       	jmp    800f25 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800fe4:	8b 54 24 04          	mov    0x4(%esp),%edx
  800fe8:	89 f1                	mov    %esi,%ecx
  ...
  800fee:	73 eb                	jae    800fdb <__udivdi3+0xf7>
		{
		  q0--;
  800ff0:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800ff3:	31 ff                	xor    %edi,%edi
  800ff5:	e9 2b ff ff ff       	jmp    800f25 <__udivdi3+0x41>
  800ffa:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800ffc:	31 f6                	xor    %esi,%esi
  800ffe:	e9 22 ff ff ff       	jmp    800f25 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  80100e:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  801012:	89 44 24 14          	mov    %eax,0x14(%esp)
  801016:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  80101a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  80101e:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  801026:	85 ed                	test   %ebp,%ebp
  801028:	75 16                	jne    801040 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  80102a:	39 f1                	cmp    %esi,%ecx
  80102c:	0f 86 a6 00 00 00    	jbe    8010d8 <__umoddi3+0xd4>
  ...
  801042:	0f 87 ac 00 00 00    	ja     8010f4 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  801048:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  80104b:	83 f0 1f             	xor    $0x1f,%eax
  80104e:	89 44 24 10          	mov    %eax,0x10(%esp)
  801052:	0f 84 a8 00 00 00    	je     801100 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  801058:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80105c:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  80105e:	bf 20 00 00 00       	mov    $0x20,%edi
  801063:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801067:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80106b:	89 f9                	mov    %edi,%ecx
  80106d:	d3 e8                	shr    %cl,%eax
  80106f:	09 e8                	or     %ebp,%eax
  801071:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801075:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801079:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80107d:	d3 e0                	shl    %cl,%eax
  80107f:	89 44 24 0c          	mov    %eax,0xc(%esp)
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  801083:	89 f2                	mov    %esi,%edx
  801085:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  801087:	8b 44 24 14          	mov    0x14(%esp),%eax
  80108b:	d3 e0                	shl    %cl,%eax
  80108d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  801091:	8b 44 24 14          	mov    0x14(%esp),%eax
  ...
  801099:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  80109b:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  80109d:	89 f2                	mov    %esi,%edx
  80109f:	f7 74 24 18          	divl   0x18(%esp)
  8010a3:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  8010a5:	f7 64 24 0c          	mull   0xc(%esp)
  8010a9:	89 c5                	mov    %eax,%ebp
  8010ab:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010ad:	39 d6                	cmp    %edx,%esi
  8010af:	72 67                	jb     801118 <__umoddi3+0x114>
  8010b1:	74 75                	je     801128 <__umoddi3+0x124>
	      q1 = 0;
  ...
  8010b3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b7:	29 e8                	sub    %ebp,%eax
  8010b9:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  8010bb:	8a 4c 24 10          	mov    0x10(%esp),%cl
  8010bf:	d3 e8                	shr    %cl,%eax
  8010c1:	89 f2                	mov    %esi,%edx
  8010c3:	89 f9                	mov    %edi,%ecx
  8010c5:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  ...
  8010da:	75 0b                	jne    8010e7 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  8010ef:	e9 3e ff ff ff       	jmp    801032 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  8010fd:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  801100:	39 f5                	cmp    %esi,%ebp
  801102:	72 04                	jb     801108 <__umoddi3+0x104>
  801104:	39 f9                	cmp    %edi,%ecx
  801106:	77 06                	ja     80110e <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801108:	89 f2                	mov    %esi,%edx
  80110a:	29 cf                	sub    %ecx,%edi
  80110c:	19 ea                	sbb    %ebp,%edx
  ...
  801117:	90                   	nop
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  801118:	89 d1                	mov    %edx,%ecx
  80111a:	89 c5                	mov    %eax,%ebp
  80111c:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801120:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801124:	eb 8d                	jmp    8010b3 <__umoddi3+0xaf>
  801126:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801128:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80112c:	72 ea                	jb     801118 <__umoddi3+0x114>
  80112e:	89 f1                	mov    %esi,%ecx
  801130:	eb 81                	jmp    8010b3 <__umoddi3+0xaf>
