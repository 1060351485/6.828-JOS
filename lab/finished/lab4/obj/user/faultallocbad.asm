...
handler(struct UTrapframe *utf)
{
  ...
  800044:	c7 04 24 e0 10 80 00 	movl   $0x8010e0,(%esp)
  ...
  80007b:	c7 44 24 08 00 11 80 	movl   $0x801100,0x8(%esp)
  800082:	00 
  800083:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80008a:	00 
  80008b:	c7 04 24 ea 10 80 00 	movl   $0x8010ea,(%esp)
  800092:	e8 b5 00 00 00       	call   80014c <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  800097:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80009b:	c7 44 24 08 2c 11 80 	movl   $0x80112c,0x8(%esp)
  8000a2:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800178:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
  ...
  80018e:	e8 50 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800193:	c7 04 24 e8 10 80 00 	movl   $0x8010e8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b9:	e8 d2 0b 00 00       	call   800e90 <__udivdi3>
  ...
  80030c:	e8 9f 0c 00 00       	call   800fb0 <__umoddi3>
  800311:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800315:	0f be 80 7c 11 80 00 	movsbl 0x80117c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800430:	ff 24 95 40 12 80 00 	jmp    *0x801240(,%edx,4)
  ...
  8004f0:	c7 44 24 08 9d 11 80 	movl   $0x80119d,0x8(%esp)
  8004f7:	00 
  ...
  800524:	75 05                	jne    80052b <vprintfmt+0x185>
				p = "(null)";
  800526:	be 8d 11 80 00       	mov    $0x80118d,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b7e:	00 
  800b7f:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800b86:	00 
  800b87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8e:	00 
  800b8f:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c63:	00 
  800c64:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800c6b:	00 
  800c6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c73:	00 
  800c74:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb6:	00 
  800cb7:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800cbe:	00 
  800cbf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc6:	00 
  800cc7:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d09:	00 
  800d0a:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d11:	00 
  800d12:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d19:	00 
  800d1a:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d5c:	00 
  800d5d:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d64:	00 
  800d65:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6c:	00 
  800d6d:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd1:	00 
  800dd2:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800dd9:	00 
  800dda:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de1:	00 
  800de2:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e05:	75 58                	jne    800e5f <set_pgfault_handler+0x67>
		// First time through!
  ...
  800e22:	e8 ba fd ff ff       	call   800be1 <sys_page_alloc>
  800e27:	85 c0                	test   %eax,%eax
  800e29:	74 1c                	je     800e47 <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  800e2b:	c7 44 24 08 f3 13 80 	movl   $0x8013f3,0x8(%esp)
  800e32:	00 
  800e33:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e3a:	00 
  800e3b:	c7 04 24 08 14 80 00 	movl   $0x801408,(%esp)
  800e42:	e8 05 f3 ff ff       	call   80014c <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800e47:	a1 04 20 80 00       	mov    0x802004,%eax
  800e4c:	8b 40 48             	mov    0x48(%eax),%eax
  800e4f:	c7 44 24 04 6c 0e 80 	movl   $0x800e6c,0x4(%esp)
  800e56:	00 
  800e57:	89 04 24             	mov    %eax,(%esp)
  800e5a:	e8 cf fe ff ff       	call   800d2e <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800e6d:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e74:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800e77:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  800e7b:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  800e7d:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  800e81:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800e82:	89 65 30             	mov    %esp,0x30(%ebp)
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e96:	8b 74 24 20          	mov    0x20(%esp),%esi
  800e9a:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800ea2:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800ea6:	89 cd                	mov    %ecx,%ebp
  800ea8:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800eae:	75 2c                	jne    800edc <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800eb0:	39 f9                	cmp    %edi,%ecx
  800eb2:	77 68                	ja     800f1c <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800eb6:	75 0b                	jne    800ec3 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800edb:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800edc:	39 f8                	cmp    %edi,%eax
  800ede:	77 2c                	ja     800f0c <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800ee0:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800ee3:	83 f6 1f             	xor    $0x1f,%esi
  800ee6:	75 4c                	jne    800f34 <__udivdi3+0xa4>
  ...
  800eea:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800eef:	72 0a                	jb     800efb <__udivdi3+0x6b>
  800ef1:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800ef5:	0f 87 ad 00 00 00    	ja     800fa8 <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800efb:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f41:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800f43:	89 ea                	mov    %ebp,%edx
  800f45:	88 c1                	mov    %al,%cl
  800f47:	d3 ea                	shr    %cl,%edx
  800f49:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800f4d:	09 ca                	or     %ecx,%edx
  800f4f:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800f53:	89 f1                	mov    %esi,%ecx
  800f55:	d3 e5                	shl    %cl,%ebp
  800f57:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800f5b:	89 fd                	mov    %edi,%ebp
  800f5d:	88 c1                	mov    %al,%cl
  800f5f:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800f61:	89 fa                	mov    %edi,%edx
  800f63:	89 f1                	mov    %esi,%ecx
  800f65:	d3 e2                	shl    %cl,%edx
  800f67:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f6b:	88 c1                	mov    %al,%cl
  800f6d:	d3 ef                	shr    %cl,%edi
  800f6f:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f71:	89 f8                	mov    %edi,%eax
  800f73:	89 ea                	mov    %ebp,%edx
  800f75:	f7 74 24 08          	divl   0x8(%esp)
  800f79:	89 d1                	mov    %edx,%ecx
  800f7b:	89 c7                	mov    %eax,%edi
	      umul_ppmm (m1, m0, q0, d0);
  800f7d:	f7 64 24 0c          	mull   0xc(%esp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800f81:	39 d1                	cmp    %edx,%ecx
  800f83:	72 17                	jb     800f9c <__udivdi3+0x10c>
  800f85:	74 09                	je     800f90 <__udivdi3+0x100>
  800f87:	89 fe                	mov    %edi,%esi
  800f89:	31 ff                	xor    %edi,%edi
  800f8b:	e9 41 ff ff ff       	jmp    800ed1 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800f90:	8b 54 24 04          	mov    0x4(%esp),%edx
  800f94:	89 f1                	mov    %esi,%ecx
  800f96:	d3 e2                	shl    %cl,%edx
  ...
  800f9a:	73 eb                	jae    800f87 <__udivdi3+0xf7>
		{
		  q0--;
  800f9c:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f9f:	31 ff                	xor    %edi,%edi
  800fa1:	e9 2b ff ff ff       	jmp    800ed1 <__udivdi3+0x41>
  800fa6:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800fa8:	31 f6                	xor    %esi,%esi
  800faa:	e9 22 ff ff ff       	jmp    800ed1 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800fb6:	8b 44 24 30          	mov    0x30(%esp),%eax
  800fba:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800fbe:	89 44 24 14          	mov    %eax,0x14(%esp)
  800fc2:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800fc6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800fca:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
  ...
  800fd4:	75 16                	jne    800fec <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800fd6:	39 f1                	cmp    %esi,%ecx
  800fd8:	0f 86 a6 00 00 00    	jbe    801084 <__umoddi3+0xd4>
  ...
  800fee:	0f 87 ac 00 00 00    	ja     8010a0 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800ff4:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  800ff7:	83 f0 1f             	xor    $0x1f,%eax
  800ffa:	89 44 24 10          	mov    %eax,0x10(%esp)
  800ffe:	0f 84 a8 00 00 00    	je     8010ac <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  801004:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801008:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  80100a:	bf 20 00 00 00       	mov    $0x20,%edi
  80100f:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801013:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801017:	89 f9                	mov    %edi,%ecx
  801019:	d3 e8                	shr    %cl,%eax
  80101b:	09 e8                	or     %ebp,%eax
  80101d:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801021:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801025:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801031:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  801033:	8b 44 24 14          	mov    0x14(%esp),%eax
  801037:	d3 e0                	shl    %cl,%eax
  801039:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  80103d:	8b 44 24 14          	mov    0x14(%esp),%eax
  ...
  80104b:	f7 74 24 18          	divl   0x18(%esp)
  80104f:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801051:	f7 64 24 0c          	mull   0xc(%esp)
  801055:	89 c5                	mov    %eax,%ebp
  801057:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801059:	39 d6                	cmp    %edx,%esi
  80105b:	72 67                	jb     8010c4 <__umoddi3+0x114>
  80105d:	74 75                	je     8010d4 <__umoddi3+0x124>
	      q1 = 0;
  ...
  80105f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801063:	29 e8                	sub    %ebp,%eax
  801065:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  801067:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80106b:	d3 e8                	shr    %cl,%eax
  80106d:	89 f2                	mov    %esi,%edx
  80106f:	89 f9                	mov    %edi,%ecx
  801071:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  801073:	09 d0                	or     %edx,%eax
  801075:	89 f2                	mov    %esi,%edx
  801077:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801086:	75 0b                	jne    801093 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  80109b:	e9 3e ff ff ff       	jmp    800fde <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  8010a9:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  8010ac:	39 f5                	cmp    %esi,%ebp
  8010ae:	72 04                	jb     8010b4 <__umoddi3+0x104>
  8010b0:	39 f9                	cmp    %edi,%ecx
  8010b2:	77 06                	ja     8010ba <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  8010b4:	89 f2                	mov    %esi,%edx
  8010b6:	29 cf                	sub    %ecx,%edi
  ...
  8010c8:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  8010cc:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  8010d0:	eb 8d                	jmp    80105f <__umoddi3+0xaf>
  8010d2:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010d4:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010d8:	72 ea                	jb     8010c4 <__umoddi3+0x114>
  8010da:	89 f1                	mov    %esi,%ecx
  8010dc:	eb 81                	jmp    80105f <__umoddi3+0xaf>
