...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80018c:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
  ...
  8001a2:	e8 50 00 00 00       	call   8001f7 <vcprintf>
	cprintf("\n");
  8001a7:	c7 04 24 1e 11 80 00 	movl   $0x80111e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cd:	e8 d2 0b 00 00       	call   800ea4 <__udivdi3>
  ...
  800320:	e8 9f 0c 00 00       	call   800fc4 <__umoddi3>
  800325:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800329:	0f be 80 9c 11 80 00 	movsbl 0x80119c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800444:	ff 24 95 60 12 80 00 	jmp    *0x801260(,%edx,4)
  ...
  800504:	c7 44 24 08 bd 11 80 	movl   $0x8011bd,0x8(%esp)
  80050b:	00 
  ...
  800538:	75 05                	jne    80053f <vprintfmt+0x185>
				p = "(null)";
  80053a:	be ad 11 80 00       	mov    $0x8011ad,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b92:	00 
  800b93:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800b9a:	00 
  800b9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba2:	00 
  800ba3:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c24:	00 
  800c25:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c2c:	00 
  800c2d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c34:	00 
  800c35:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c77:	00 
  800c78:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c7f:	00 
  800c80:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c87:	00 
  800c88:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cca:	00 
  800ccb:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800cd2:	00 
  800cd3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cda:	00 
  800cdb:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1d:	00 
  800d1e:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800d25:	00 
  800d26:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2d:	00 
  800d2e:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d70:	00 
  800d71:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800d78:	00 
  800d79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d80:	00 
  800d81:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de5:	00 
  800de6:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800ded:	00 
  800dee:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df5:	00 
  800df6:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e36:	e8 ba fd ff ff       	call   800bf5 <sys_page_alloc>
  800e3b:	85 c0                	test   %eax,%eax
  800e3d:	74 1c                	je     800e5b <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  800e3f:	c7 44 24 08 13 14 80 	movl   $0x801413,0x8(%esp)
  800e46:	00 
  800e47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4e:	00 
  800e4f:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  800e56:	e8 05 f3 ff ff       	call   800160 <_panic>
		}
  ...
  800e6e:	e8 cf fe ff ff       	call   800d42 <sys_env_set_pgfault_upcall>
	}
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800eaa:	8b 74 24 20          	mov    0x20(%esp),%esi
  800eae:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800eb6:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800eba:	89 cd                	mov    %ecx,%ebp
  800ebc:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800ec2:	75 2c                	jne    800ef0 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800ec4:	39 f9                	cmp    %edi,%ecx
  800ec6:	77 68                	ja     800f30 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800eca:	75 0b                	jne    800ed7 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800ef2:	77 2c                	ja     800f20 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800ef4:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800ef7:	83 f6 1f             	xor    $0x1f,%esi
  800efa:	75 4c                	jne    800f48 <__udivdi3+0xa4>
  ...
  800efe:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800f03:	72 0a                	jb     800f0f <__udivdi3+0x6b>
  800f05:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800f09:	0f 87 ad 00 00 00    	ja     800fbc <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f0f:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f45:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800f48:	89 f1                	mov    %esi,%ecx
  800f4a:	d3 e0                	shl    %cl,%eax
  ...
  800f55:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800f57:	89 ea                	mov    %ebp,%edx
  800f59:	88 c1                	mov    %al,%cl
  800f5b:	d3 ea                	shr    %cl,%edx
  800f5d:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800f61:	09 ca                	or     %ecx,%edx
  800f63:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800f67:	89 f1                	mov    %esi,%ecx
  800f69:	d3 e5                	shl    %cl,%ebp
  800f6b:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800f6f:	89 fd                	mov    %edi,%ebp
  800f71:	88 c1                	mov    %al,%cl
  800f73:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800f75:	89 fa                	mov    %edi,%edx
  800f77:	89 f1                	mov    %esi,%ecx
  800f79:	d3 e2                	shl    %cl,%edx
  800f7b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f7f:	88 c1                	mov    %al,%cl
  800f81:	d3 ef                	shr    %cl,%edi
  800f83:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f85:	89 f8                	mov    %edi,%eax
  800f87:	89 ea                	mov    %ebp,%edx
  800f89:	f7 74 24 08          	divl   0x8(%esp)
  ...
  800f95:	39 d1                	cmp    %edx,%ecx
  800f97:	72 17                	jb     800fb0 <__udivdi3+0x10c>
  800f99:	74 09                	je     800fa4 <__udivdi3+0x100>
  800f9b:	89 fe                	mov    %edi,%esi
  800f9d:	31 ff                	xor    %edi,%edi
  800f9f:	e9 41 ff ff ff       	jmp    800ee5 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800fa4:	8b 54 24 04          	mov    0x4(%esp),%edx
  ...
  800faa:	d3 e2                	shl    %cl,%edx
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800fac:	39 c2                	cmp    %eax,%edx
  800fae:	73 eb                	jae    800f9b <__udivdi3+0xf7>
		{
		  q0--;
  800fb0:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800fb3:	31 ff                	xor    %edi,%edi
  800fb5:	e9 2b ff ff ff       	jmp    800ee5 <__udivdi3+0x41>
  800fba:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800fbc:	31 f6                	xor    %esi,%esi
  800fbe:	e9 22 ff ff ff       	jmp    800ee5 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800fca:	8b 44 24 30          	mov    0x30(%esp),%eax
  800fce:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800fd2:	89 44 24 14          	mov    %eax,0x14(%esp)
  800fd6:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800fda:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800fde:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800fe6:	85 ed                	test   %ebp,%ebp
  800fe8:	75 16                	jne    801000 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800fea:	39 f1                	cmp    %esi,%ecx
  800fec:	0f 86 a6 00 00 00    	jbe    801098 <__umoddi3+0xd4>
  ...
  800fff:	90                   	nop
    ...
    {
      if (d1 > n1)
  801000:	39 f5                	cmp    %esi,%ebp
  801002:	0f 87 ac 00 00 00    	ja     8010b4 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  801008:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  80100b:	83 f0 1f             	xor    $0x1f,%eax
  80100e:	89 44 24 10          	mov    %eax,0x10(%esp)
  801012:	0f 84 a8 00 00 00    	je     8010c0 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  801018:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80101c:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  80101e:	bf 20 00 00 00       	mov    $0x20,%edi
  801023:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801027:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80102b:	89 f9                	mov    %edi,%ecx
  80102d:	d3 e8                	shr    %cl,%eax
  80102f:	09 e8                	or     %ebp,%eax
  801031:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801035:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801039:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801045:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  801047:	8b 44 24 14          	mov    0x14(%esp),%eax
  80104b:	d3 e0                	shl    %cl,%eax
  80104d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  801051:	8b 44 24 14          	mov    0x14(%esp),%eax
  ...
  801059:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  80105b:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  80105d:	89 f2                	mov    %esi,%edx
  80105f:	f7 74 24 18          	divl   0x18(%esp)
  801063:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801065:	f7 64 24 0c          	mull   0xc(%esp)
  801069:	89 c5                	mov    %eax,%ebp
  80106b:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  80106d:	39 d6                	cmp    %edx,%esi
  80106f:	72 67                	jb     8010d8 <__umoddi3+0x114>
  801071:	74 75                	je     8010e8 <__umoddi3+0x124>
	      q1 = 0;
  ...
  801077:	29 e8                	sub    %ebp,%eax
  801079:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  80107b:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  80108b:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801097:	c3                   	ret    
      ...
      else
	{
	  ...
	  if (d0 == 0)
  801098:	85 c9                	test   %ecx,%ecx
  80109a:	75 0b                	jne    8010a7 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  8010af:	e9 3e ff ff ff       	jmp    800ff2 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  8010c2:	72 04                	jb     8010c8 <__umoddi3+0x104>
  8010c4:	39 f9                	cmp    %edi,%ecx
  8010c6:	77 06                	ja     8010ce <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  8010c8:	89 f2                	mov    %esi,%edx
  8010ca:	29 cf                	sub    %ecx,%edi
  8010cc:	19 ea                	sbb    %ebp,%edx
  ...
  8010dc:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  8010e0:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  8010e4:	eb 8d                	jmp    801073 <__umoddi3+0xaf>
  8010e6:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010e8:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010ec:	72 ea                	jb     8010d8 <__umoddi3+0x114>
  8010ee:	89 f1                	mov    %esi,%ecx
  8010f0:	eb 81                	jmp    801073 <__umoddi3+0xaf>
