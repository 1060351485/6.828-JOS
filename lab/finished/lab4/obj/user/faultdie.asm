	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800205:	e8 2a 0c 00 00       	call   800e34 <__udivdi3>
  ...
  800258:	e8 f7 0c 00 00       	call   800f54 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae2:	e8 f5 02 00 00       	call   800ddc <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b74:	e8 63 02 00 00       	call   800ddc <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc7:	e8 10 02 00 00       	call   800ddc <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1a:	e8 bd 01 00 00       	call   800ddc <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c6d:	e8 6a 01 00 00       	call   800ddc <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cc0:	e8 17 01 00 00       	call   800ddc <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d35:	e8 a2 00 00 00       	call   800ddc <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d51:	75 58                	jne    800dab <set_pgfault_handler+0x67>
		// First time through!
		// LAB 4: Your code here.	
		//panic("set_pgfault_handler not implemented");
		
		if (sys_page_alloc(thisenv->env_id,(void *) (UXSTACKTOP - PGSIZE),(PTE_W|PTE_U|PTE_P)) != 0){
  800d53:	a1 04 20 80 00       	mov    0x802004,%eax
  800d58:	8b 40 48             	mov    0x48(%eax),%eax
  800d5b:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800d62:	00 
  800d63:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800d6a:	ee 
  800d6b:	89 04 24             	mov    %eax,(%esp)
  800d6e:	e8 ba fd ff ff       	call   800b2d <sys_page_alloc>
  800d73:	85 c0                	test   %eax,%eax
  800d75:	74 1c                	je     800d93 <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  800d77:	c7 44 24 08 33 13 80 	movl   $0x801333,0x8(%esp)
  800d7e:	00 
  800d7f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d86:	00 
  800d87:	c7 04 24 48 13 80 00 	movl   $0x801348,(%esp)
  800d8e:	e8 49 00 00 00       	call   800ddc <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800d93:	a1 04 20 80 00       	mov    0x802004,%eax
  800d98:	8b 40 48             	mov    0x48(%eax),%eax
  800d9b:	c7 44 24 04 b8 0d 80 	movl   $0x800db8,0x4(%esp)
  800da2:	00 
  800da3:	89 04 24             	mov    %eax,(%esp)
  800da6:	e8 cf fe ff ff       	call   800c7a <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800db9:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800dc0:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800dc3:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  800dc7:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  800dc9:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  800dcd:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800dce:	89 65 30             	mov    %esp,0x30(%ebp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800de1:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800de4:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800de7:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800ded:	e8 fd fc ff ff       	call   800aef <sys_getenvid>
  800df2:	8b 55 0c             	mov    0xc(%ebp),%edx
  800df5:	89 54 24 10          	mov    %edx,0x10(%esp)
  800df9:	8b 55 08             	mov    0x8(%ebp),%edx
  800dfc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e00:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800e04:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e08:	c7 04 24 58 13 80 00 	movl   $0x801358,(%esp)
  800e0f:	e8 7c f3 ff ff       	call   800190 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e14:	89 74 24 04          	mov    %esi,0x4(%esp)
  800e18:	8b 45 10             	mov    0x10(%ebp),%eax
  800e1b:	89 04 24             	mov    %eax,(%esp)
  800e1e:	e8 0c f3 ff ff       	call   80012f <vcprintf>
	cprintf("\n");
  800e23:	c7 04 24 ba 10 80 00 	movl   $0x8010ba,(%esp)
  800e2a:	e8 61 f3 ff ff       	call   800190 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e2f:	cc                   	int3   
  800e30:	eb fd                	jmp    800e2f <_panic+0x53>
	...
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e3e:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800e46:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800e4a:	89 cd                	mov    %ecx,%ebp
  800e4c:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800e52:	75 2c                	jne    800e80 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800e54:	39 f9                	cmp    %edi,%ecx
  800e56:	77 68                	ja     800ec0 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800e5a:	75 0b                	jne    800e67 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e82:	77 2c                	ja     800eb0 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800e84:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800e87:	83 f6 1f             	xor    $0x1f,%esi
  800e8a:	75 4c                	jne    800ed8 <__udivdi3+0xa4>
  ...
  800e8e:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800e93:	72 0a                	jb     800e9f <__udivdi3+0x6b>
  800e95:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800e99:	0f 87 ad 00 00 00    	ja     800f4c <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800e9f:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800edc:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  800ee0:	b8 20 00 00 00       	mov    $0x20,%eax
  800ee5:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800ee7:	89 ea                	mov    %ebp,%edx
  800ee9:	88 c1                	mov    %al,%cl
  800eeb:	d3 ea                	shr    %cl,%edx
  800eed:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800ef1:	09 ca                	or     %ecx,%edx
  800ef3:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800ef7:	89 f1                	mov    %esi,%ecx
  800ef9:	d3 e5                	shl    %cl,%ebp
  800efb:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800eff:	89 fd                	mov    %edi,%ebp
  ...
  800f0b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f0f:	88 c1                	mov    %al,%cl
  800f11:	d3 ef                	shr    %cl,%edi
  800f13:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f15:	89 f8                	mov    %edi,%eax
  ...
  800f25:	39 d1                	cmp    %edx,%ecx
  800f27:	72 17                	jb     800f40 <__udivdi3+0x10c>
  800f29:	74 09                	je     800f34 <__udivdi3+0x100>
  800f2b:	89 fe                	mov    %edi,%esi
  800f2d:	31 ff                	xor    %edi,%edi
  800f2f:	e9 41 ff ff ff       	jmp    800e75 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800f34:	8b 54 24 04          	mov    0x4(%esp),%edx
  800f38:	89 f1                	mov    %esi,%ecx
  ...
  800f3e:	73 eb                	jae    800f2b <__udivdi3+0xf7>
		{
		  q0--;
  800f40:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f43:	31 ff                	xor    %edi,%edi
  800f45:	e9 2b ff ff ff       	jmp    800e75 <__udivdi3+0x41>
  ...
  800f4e:	e9 22 ff ff ff       	jmp    800e75 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800f5a:	8b 44 24 30          	mov    0x30(%esp),%eax
  800f5e:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800f62:	89 44 24 14          	mov    %eax,0x14(%esp)
  800f66:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800f6a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800f6e:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800f76:	85 ed                	test   %ebp,%ebp
  800f78:	75 16                	jne    800f90 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800f7a:	39 f1                	cmp    %esi,%ecx
  800f7c:	0f 86 a6 00 00 00    	jbe    801028 <__umoddi3+0xd4>
  ...
  800f92:	0f 87 ac 00 00 00    	ja     801044 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800f98:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  800f9b:	83 f0 1f             	xor    $0x1f,%eax
  800f9e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800fa2:	0f 84 a8 00 00 00    	je     801050 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800fa8:	8a 4c 24 10          	mov    0x10(%esp),%cl
  800fac:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800fb3:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  800fb7:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800fbb:	89 f9                	mov    %edi,%ecx
  800fbd:	d3 e8                	shr    %cl,%eax
  800fbf:	09 e8                	or     %ebp,%eax
  800fc1:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  800fc5:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800fc9:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  800fd5:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800fd7:	8b 44 24 14          	mov    0x14(%esp),%eax
  800fdb:	d3 e0                	shl    %cl,%eax
  800fdd:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800fe1:	8b 44 24 14          	mov    0x14(%esp),%eax
  800fe5:	89 f9                	mov    %edi,%ecx
  800fe7:	d3 e8                	shr    %cl,%eax
  800fe9:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800feb:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800fed:	89 f2                	mov    %esi,%edx
  800fef:	f7 74 24 18          	divl   0x18(%esp)
  800ff3:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800ff5:	f7 64 24 0c          	mull   0xc(%esp)
  800ff9:	89 c5                	mov    %eax,%ebp
  800ffb:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800ffd:	39 d6                	cmp    %edx,%esi
  800fff:	72 67                	jb     801068 <__umoddi3+0x114>
  801001:	74 75                	je     801078 <__umoddi3+0x124>
	      q1 = 0;
  ...
  801015:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  801017:	09 d0                	or     %edx,%eax
  801019:	89 f2                	mov    %esi,%edx
  80101b:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801027:	c3                   	ret    
      ...
      else
	{
	  ...
	  if (d0 == 0)
  801028:	85 c9                	test   %ecx,%ecx
  80102a:	75 0b                	jne    801037 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  80103f:	e9 3e ff ff ff       	jmp    800f82 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  801052:	72 04                	jb     801058 <__umoddi3+0x104>
  801054:	39 f9                	cmp    %edi,%ecx
  801056:	77 06                	ja     80105e <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801058:	89 f2                	mov    %esi,%edx
  80105a:	29 cf                	sub    %ecx,%edi
  80105c:	19 ea                	sbb    %ebp,%edx
  ...
  80106c:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801070:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801074:	eb 8d                	jmp    801003 <__umoddi3+0xaf>
  801076:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801078:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80107c:	72 ea                	jb     801068 <__umoddi3+0x114>
  80107e:	89 f1                	mov    %esi,%ecx
  801080:	eb 81                	jmp    801003 <__umoddi3+0xaf>
