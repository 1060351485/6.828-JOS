...
umain(int argc, char **argv)
{
  ...
  8000bc:	e8 28 0d 00 00       	call   800de9 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800241:	e8 ae 0c 00 00       	call   800ef4 <__udivdi3>
  ...
  800294:	e8 7b 0d 00 00       	call   801014 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b06:	00 
  800b07:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800b0e:	00 
  800b0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b16:	00 
  800b17:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800b1e:	e8 79 03 00 00       	call   800e9c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b98:	00 
  800b99:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800ba0:	00 
  800ba1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba8:	00 
  800ba9:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800bb0:	e8 e7 02 00 00       	call   800e9c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800beb:	00 
  800bec:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800bf3:	00 
  800bf4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bfb:	00 
  800bfc:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800c03:	e8 94 02 00 00       	call   800e9c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c3e:	00 
  800c3f:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c46:	00 
  800c47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c4e:	00 
  800c4f:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800c56:	e8 41 02 00 00       	call   800e9c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c91:	00 
  800c92:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c99:	00 
  800c9a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca1:	00 
  800ca2:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800ca9:	e8 ee 01 00 00       	call   800e9c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce4:	00 
  800ce5:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf4:	00 
  800cf5:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800cfc:	e8 9b 01 00 00       	call   800e9c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d59:	00 
  800d5a:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800d61:	00 
  800d62:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d69:	00 
  800d6a:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800d71:	e8 26 01 00 00       	call   800e9c <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d95:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800d9a:	89 04 24             	mov    %eax,(%esp)
  800d9d:	e8 8a ff ff ff       	call   800d2c <sys_ipc_recv>
	if (from_env_store != NULL)
  800da2:	85 db                	test   %ebx,%ebx
  800da4:	74 0b                	je     800db1 <ipc_recv+0x31>
		*from_env_store = thisenv->env_ipc_from; 
  800da6:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800dac:	8b 52 74             	mov    0x74(%edx),%edx
  800daf:	89 13                	mov    %edx,(%ebx)
	if (perm_store != NULL)
  800db1:	85 f6                	test   %esi,%esi
  800db3:	74 0b                	je     800dc0 <ipc_recv+0x40>
		*perm_store = thisenv->env_ipc_perm;
  800db5:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800dbb:	8b 52 78             	mov    0x78(%edx),%edx
  800dbe:	89 16                	mov    %edx,(%esi)
	
	if (r < 0){
  800dc0:	85 c0                	test   %eax,%eax
  800dc2:	79 16                	jns    800dda <ipc_recv+0x5a>
		if(from_env_store != NULL)
  800dc4:	85 db                	test   %ebx,%ebx
  800dc6:	74 06                	je     800dce <ipc_recv+0x4e>
			*from_env_store = 0;
  800dc8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		if(perm_store != NULL)	
  800dce:	85 f6                	test   %esi,%esi
  800dd0:	74 10                	je     800de2 <ipc_recv+0x62>
			*perm_store = 0;
  800dd2:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  800dd8:	eb 08                	jmp    800de2 <ipc_recv+0x62>
		return r;
	}
	
	return thisenv->env_ipc_value;
  800dda:	a1 04 20 80 00       	mov    0x802004,%eax
  800ddf:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800df5:	8b 7d 0c             	mov    0xc(%ebp),%edi
  800df8:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
	int r;
	while((r = sys_ipc_try_send(to_env, val, pg?pg:(void*)UTOP, perm)) < 0){
  800dfb:	eb 2a                	jmp    800e27 <ipc_send+0x3e>
		if (r != -E_IPC_NOT_RECV)
  800dfd:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800e00:	74 20                	je     800e22 <ipc_send+0x39>
			panic("ipc_send: sys_ipc_try_send failed %e", r);
  800e02:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800e06:	c7 44 24 08 14 14 80 	movl   $0x801414,0x8(%esp)
  800e0d:	00 
  800e0e:	c7 44 24 04 3e 00 00 	movl   $0x3e,0x4(%esp)
  800e15:	00 
  800e16:	c7 04 24 39 14 80 00 	movl   $0x801439,(%esp)
  800e1d:	e8 7a 00 00 00       	call   800e9c <_panic>
		sys_yield();
  800e22:	e8 23 fd ff ff       	call   800b4a <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
  ...
  800e29:	75 07                	jne    800e32 <ipc_send+0x49>
  800e2b:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800e30:	eb 02                	jmp    800e34 <ipc_send+0x4b>
  800e32:	89 d8                	mov    %ebx,%eax
  800e34:	8b 55 14             	mov    0x14(%ebp),%edx
  800e37:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e3b:	89 44 24 08          	mov    %eax,0x8(%esp)
  800e3f:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800e43:	89 34 24             	mov    %esi,(%esp)
  800e46:	e8 be fe ff ff       	call   800d09 <sys_ipc_try_send>
  800e4b:	85 c0                	test   %eax,%eax
  800e4d:	78 ae                	js     800dfd <ipc_send+0x14>
		if (r != -E_IPC_NOT_RECV)
			panic("ipc_send: sys_ipc_try_send failed %e", r);
		sys_yield();
	}
}
  800e4f:	83 c4 1c             	add    $0x1c,%esp
  800e52:	5b                   	pop    %ebx
  800e53:	5e                   	pop    %esi
  800e54:	5f                   	pop    %edi
  800e55:	5d                   	pop    %ebp
...
ipc_find_env(enum EnvType type)
{
  ...
  800e5a:	53                   	push   %ebx
  800e5b:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int i;
	for (i = 0; i < NENV; i++)
  800e5e:	b8 00 00 00 00       	mov    $0x0,%eax
		if (envs[i].env_type == type)
  800e63:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  800e6a:	89 c2                	mov    %eax,%edx
  800e6c:	c1 e2 07             	shl    $0x7,%edx
  800e6f:	29 ca                	sub    %ecx,%edx
  800e71:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800e77:	8b 52 50             	mov    0x50(%edx),%edx
  800e7a:	39 da                	cmp    %ebx,%edx
  800e7c:	75 0f                	jne    800e8d <ipc_find_env+0x36>
			return envs[i].env_id;
  800e7e:	c1 e0 07             	shl    $0x7,%eax
  800e81:	29 c8                	sub    %ecx,%eax
  800e83:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800e88:	8b 40 40             	mov    0x40(%eax),%eax
  800e8b:	eb 0c                	jmp    800e99 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800e93:	75 ce                	jne    800e63 <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800e95:	66 b8 00 00          	mov    $0x0,%ax
}
  800e99:	5b                   	pop    %ebx
  800e9a:	5d                   	pop    %ebp
  800e9b:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ea1:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800ea4:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800ea7:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800ead:	e8 79 fc ff ff       	call   800b2b <sys_getenvid>
  ...
  800ec0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800ec4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ec8:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  800ecf:	e8 f8 f2 ff ff       	call   8001cc <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ed4:	89 74 24 04          	mov    %esi,0x4(%esp)
  800ed8:	8b 45 10             	mov    0x10(%ebp),%eax
  800edb:	89 04 24             	mov    %eax,(%esp)
  800ede:	e8 88 f2 ff ff       	call   80016b <vcprintf>
	cprintf("\n");
  800ee3:	c7 04 24 6f 11 80 00 	movl   $0x80116f,(%esp)
  800eea:	e8 dd f2 ff ff       	call   8001cc <cprintf>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800efe:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800f06:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800f0a:	89 cd                	mov    %ecx,%ebp
  800f0c:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800f12:	75 2c                	jne    800f40 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800f14:	39 f9                	cmp    %edi,%ecx
  800f16:	77 68                	ja     800f80 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800f1a:	75 0b                	jne    800f27 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f3f:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800f40:	39 f8                	cmp    %edi,%eax
  800f42:	77 2c                	ja     800f70 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800f44:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800f47:	83 f6 1f             	xor    $0x1f,%esi
  800f4a:	75 4c                	jne    800f98 <__udivdi3+0xa4>
  ...
  800f4e:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800f53:	72 0a                	jb     800f5f <__udivdi3+0x6b>
  800f55:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800f59:	0f 87 ad 00 00 00    	ja     80100c <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f5f:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f95:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800f98:	89 f1                	mov    %esi,%ecx
  800f9a:	d3 e0                	shl    %cl,%eax
  800f9c:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800fa0:	b8 20 00 00 00       	mov    $0x20,%eax
  800fa5:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800fa7:	89 ea                	mov    %ebp,%edx
  800fa9:	88 c1                	mov    %al,%cl
  800fab:	d3 ea                	shr    %cl,%edx
  800fad:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800fb1:	09 ca                	or     %ecx,%edx
  800fb3:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800fb7:	89 f1                	mov    %esi,%ecx
  800fb9:	d3 e5                	shl    %cl,%ebp
  800fbb:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800fbf:	89 fd                	mov    %edi,%ebp
  800fc1:	88 c1                	mov    %al,%cl
  800fc3:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800fc5:	89 fa                	mov    %edi,%edx
  800fc7:	89 f1                	mov    %esi,%ecx
  800fc9:	d3 e2                	shl    %cl,%edx
  800fcb:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800fcf:	88 c1                	mov    %al,%cl
  800fd1:	d3 ef                	shr    %cl,%edi
  800fd3:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800fd5:	89 f8                	mov    %edi,%eax
  800fd7:	89 ea                	mov    %ebp,%edx
  800fd9:	f7 74 24 08          	divl   0x8(%esp)
  ...
  800fe5:	39 d1                	cmp    %edx,%ecx
  800fe7:	72 17                	jb     801000 <__udivdi3+0x10c>
  800fe9:	74 09                	je     800ff4 <__udivdi3+0x100>
  800feb:	89 fe                	mov    %edi,%esi
  800fed:	31 ff                	xor    %edi,%edi
  800fef:	e9 41 ff ff ff       	jmp    800f35 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800ff4:	8b 54 24 04          	mov    0x4(%esp),%edx
  800ff8:	89 f1                	mov    %esi,%ecx
  ...
  800ffe:	73 eb                	jae    800feb <__udivdi3+0xf7>
		{
		  q0--;
  801000:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  801003:	31 ff                	xor    %edi,%edi
  801005:	e9 2b ff ff ff       	jmp    800f35 <__udivdi3+0x41>
  80100a:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  80100c:	31 f6                	xor    %esi,%esi
  80100e:	e9 22 ff ff ff       	jmp    800f35 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  80101a:	8b 44 24 30          	mov    0x30(%esp),%eax
  80101e:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  801022:	89 44 24 14          	mov    %eax,0x14(%esp)
  801026:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  80102a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  80102e:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  801036:	85 ed                	test   %ebp,%ebp
  801038:	75 16                	jne    801050 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  80103a:	39 f1                	cmp    %esi,%ecx
  80103c:	0f 86 a6 00 00 00    	jbe    8010e8 <__umoddi3+0xd4>
  ...
  80104f:	90                   	nop
    ...
    {
      if (d1 > n1)
  801050:	39 f5                	cmp    %esi,%ebp
  801052:	0f 87 ac 00 00 00    	ja     801104 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  801058:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  80105b:	83 f0 1f             	xor    $0x1f,%eax
  80105e:	89 44 24 10          	mov    %eax,0x10(%esp)
  801062:	0f 84 a8 00 00 00    	je     801110 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  801068:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80106c:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  80106e:	bf 20 00 00 00       	mov    $0x20,%edi
  801073:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801077:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80107b:	89 f9                	mov    %edi,%ecx
  80107d:	d3 e8                	shr    %cl,%eax
  80107f:	09 e8                	or     %ebp,%eax
  801081:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801085:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801089:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801095:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  801097:	8b 44 24 14          	mov    0x14(%esp),%eax
  80109b:	d3 e0                	shl    %cl,%eax
  80109d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  8010a1:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010a5:	89 f9                	mov    %edi,%ecx
  8010a7:	d3 e8                	shr    %cl,%eax
  8010a9:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  8010ab:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  8010ad:	89 f2                	mov    %esi,%edx
  8010af:	f7 74 24 18          	divl   0x18(%esp)
  8010b3:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  8010b5:	f7 64 24 0c          	mull   0xc(%esp)
  8010b9:	89 c5                	mov    %eax,%ebp
  8010bb:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010bd:	39 d6                	cmp    %edx,%esi
  8010bf:	72 67                	jb     801128 <__umoddi3+0x114>
  8010c1:	74 75                	je     801138 <__umoddi3+0x124>
	      q1 = 0;
  ...
  8010c3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c7:	29 e8                	sub    %ebp,%eax
  8010c9:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  8010cb:	8a 4c 24 10          	mov    0x10(%esp),%cl
  8010cf:	d3 e8                	shr    %cl,%eax
  8010d1:	89 f2                	mov    %esi,%edx
  8010d3:	89 f9                	mov    %edi,%ecx
  8010d5:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  8010d7:	09 d0                	or     %edx,%eax
  ...
  8010ea:	75 0b                	jne    8010f7 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  8010ff:	e9 3e ff ff ff       	jmp    801042 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  80110d:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  801110:	39 f5                	cmp    %esi,%ebp
  801112:	72 04                	jb     801118 <__umoddi3+0x104>
  801114:	39 f9                	cmp    %edi,%ecx
  801116:	77 06                	ja     80111e <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801118:	89 f2                	mov    %esi,%edx
  80111a:	29 cf                	sub    %ecx,%edi
  80111c:	19 ea                	sbb    %ebp,%edx
  ...
  80112c:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801130:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801134:	eb 8d                	jmp    8010c3 <__umoddi3+0xaf>
  801136:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801138:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80113c:	72 ea                	jb     801128 <__umoddi3+0x114>
  80113e:	89 f1                	mov    %esi,%ecx
  801140:	eb 81                	jmp    8010c3 <__umoddi3+0xaf>
