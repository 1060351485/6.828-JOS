...
umain(int argc, char **argv)
{
  ...
  800055:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
  80005c:	e8 ff 00 00 00       	call   800160 <cprintf>
}
  800061:	c9                   	leave  
  800062:	c3                   	ret    
	...
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 48 0a 00 00       	call   800abf <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d5:	e8 66 0c 00 00       	call   800e40 <__udivdi3>
  ...
  800228:	e8 33 0d 00 00       	call   800f60 <__umoddi3>
  80022d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800231:	0f be 80 b8 10 80 00 	movsbl 0x8010b8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034c:	ff 24 95 00 12 80 00 	jmp    *0x801200(,%edx,4)
  ...
  80040c:	c7 44 24 08 d9 10 80 	movl   $0x8010d9,0x8(%esp)
  800413:	00 
  ...
  800440:	75 05                	jne    800447 <vprintfmt+0x185>
				p = "(null)";
  800442:	be c9 10 80 00       	mov    $0x8010c9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9a:	00 
  800a9b:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800aa2:	00 
  800aa3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aaa:	00 
  800aab:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800ab2:	e8 31 03 00 00       	call   800de8 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b2c:	00 
  800b2d:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800b34:	00 
  800b35:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b3c:	00 
  800b3d:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800b44:	e8 9f 02 00 00       	call   800de8 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7f:	00 
  800b80:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800b87:	00 
  800b88:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8f:	00 
  800b90:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800b97:	e8 4c 02 00 00       	call   800de8 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800bea:	e8 f9 01 00 00       	call   800de8 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800c3d:	e8 a6 01 00 00       	call   800de8 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c6b:	7e 28                	jle    800c95 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800c6d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800c71:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800c78:	00 
  800c79:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800c90:	e8 53 01 00 00       	call   800de8 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbe:	7e 28                	jle    800ce8 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800cc0:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cc4:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800ccb:	00 
  800ccc:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800ce3:	e8 00 01 00 00       	call   800de8 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d33:	7e 28                	jle    800d5d <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d35:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d39:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800d40:	00 
  800d41:	c7 44 24 08 c7 13 80 	movl   $0x8013c7,0x8(%esp)
  800d48:	00 
  800d49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d50:	00 
  800d51:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
  800d58:	e8 8b 00 00 00       	call   800de8 <_panic>
...
sys_e1000_get_mac(uint8_t* mac_addr){
  ...
  800dd1:	b8 11 00 00 00       	mov    $0x11,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ded:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800df0:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800df3:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800df9:	e8 c1 fc ff ff       	call   800abf <sys_getenvid>
  ...
  800e0c:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800e10:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e14:	c7 04 24 f4 13 80 00 	movl   $0x8013f4,(%esp)
  800e1b:	e8 40 f3 ff ff       	call   800160 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e20:	89 74 24 04          	mov    %esi,0x4(%esp)
  800e24:	8b 45 10             	mov    0x10(%ebp),%eax
  800e27:	89 04 24             	mov    %eax,(%esp)
  800e2a:	e8 d0 f2 ff ff       	call   8000ff <vcprintf>
	cprintf("\n");
  800e2f:	c7 04 24 ac 10 80 00 	movl   $0x8010ac,(%esp)
  800e36:	e8 25 f3 ff ff       	call   800160 <cprintf>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e46:	8b 74 24 20          	mov    0x20(%esp),%esi
  800e4a:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800e52:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800e56:	89 cd                	mov    %ecx,%ebp
  800e58:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800e5e:	75 2c                	jne    800e8c <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800e60:	39 f9                	cmp    %edi,%ecx
  800e62:	77 68                	ja     800ecc <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800e66:	75 0b                	jne    800e73 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e8b:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800e8c:	39 f8                	cmp    %edi,%eax
  800e8e:	77 2c                	ja     800ebc <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800e90:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800e93:	83 f6 1f             	xor    $0x1f,%esi
  800e96:	75 4c                	jne    800ee4 <__udivdi3+0xa4>
  ...
  800e9a:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800e9f:	72 0a                	jb     800eab <__udivdi3+0x6b>
  800ea1:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800ea5:	0f 87 ad 00 00 00    	ja     800f58 <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800ef1:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800ef3:	89 ea                	mov    %ebp,%edx
  800ef5:	88 c1                	mov    %al,%cl
  800ef7:	d3 ea                	shr    %cl,%edx
  800ef9:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800efd:	09 ca                	or     %ecx,%edx
  800eff:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800f03:	89 f1                	mov    %esi,%ecx
  800f05:	d3 e5                	shl    %cl,%ebp
  800f07:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800f0b:	89 fd                	mov    %edi,%ebp
  ...
  800f17:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f1b:	88 c1                	mov    %al,%cl
  800f1d:	d3 ef                	shr    %cl,%edi
  800f1f:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f21:	89 f8                	mov    %edi,%eax
  800f23:	89 ea                	mov    %ebp,%edx
  ...
  800f31:	39 d1                	cmp    %edx,%ecx
  800f33:	72 17                	jb     800f4c <__udivdi3+0x10c>
  800f35:	74 09                	je     800f40 <__udivdi3+0x100>
  800f37:	89 fe                	mov    %edi,%esi
  800f39:	31 ff                	xor    %edi,%edi
  800f3b:	e9 41 ff ff ff       	jmp    800e81 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800f40:	8b 54 24 04          	mov    0x4(%esp),%edx
  800f44:	89 f1                	mov    %esi,%ecx
  ...
  800f4a:	73 eb                	jae    800f37 <__udivdi3+0xf7>
		{
		  q0--;
  800f4c:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f4f:	31 ff                	xor    %edi,%edi
  800f51:	e9 2b ff ff ff       	jmp    800e81 <__udivdi3+0x41>
  800f56:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800f58:	31 f6                	xor    %esi,%esi
  800f5a:	e9 22 ff ff ff       	jmp    800e81 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800f61:	57                   	push   %edi
  800f62:	56                   	push   %esi
  800f63:	83 ec 20             	sub    $0x20,%esp
  800f66:	8b 44 24 30          	mov    0x30(%esp),%eax
  800f6a:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800f6e:	89 44 24 14          	mov    %eax,0x14(%esp)
  800f72:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800f76:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800f7a:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800f82:	85 ed                	test   %ebp,%ebp
  800f84:	75 16                	jne    800f9c <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800f86:	39 f1                	cmp    %esi,%ecx
  800f88:	0f 86 a6 00 00 00    	jbe    801034 <__umoddi3+0xd4>
  ...
  800f9e:	0f 87 ac 00 00 00    	ja     801050 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800fa4:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  800fa7:	83 f0 1f             	xor    $0x1f,%eax
  800faa:	89 44 24 10          	mov    %eax,0x10(%esp)
  800fae:	0f 84 a8 00 00 00    	je     80105c <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800fb4:	8a 4c 24 10          	mov    0x10(%esp),%cl
  800fb8:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800fba:	bf 20 00 00 00       	mov    $0x20,%edi
  800fbf:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  800fc3:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800fc7:	89 f9                	mov    %edi,%ecx
  800fc9:	d3 e8                	shr    %cl,%eax
  800fcb:	09 e8                	or     %ebp,%eax
  800fcd:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  800fd1:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800fd5:	8a 4c 24 10          	mov    0x10(%esp),%cl
  800fd9:	d3 e0                	shl    %cl,%eax
  800fdb:	89 44 24 0c          	mov    %eax,0xc(%esp)
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800fdf:	89 f2                	mov    %esi,%edx
  800fe1:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800fe3:	8b 44 24 14          	mov    0x14(%esp),%eax
  800fe7:	d3 e0                	shl    %cl,%eax
  800fe9:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800fed:	8b 44 24 14          	mov    0x14(%esp),%eax
  800ff1:	89 f9                	mov    %edi,%ecx
  800ff3:	d3 e8                	shr    %cl,%eax
  800ff5:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800ff7:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800ff9:	89 f2                	mov    %esi,%edx
  800ffb:	f7 74 24 18          	divl   0x18(%esp)
  800fff:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801001:	f7 64 24 0c          	mull   0xc(%esp)
  801005:	89 c5                	mov    %eax,%ebp
  801007:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801009:	39 d6                	cmp    %edx,%esi
  80100b:	72 67                	jb     801074 <__umoddi3+0x114>
  80100d:	74 75                	je     801084 <__umoddi3+0x124>
	      q1 = 0;
  ...
  80100f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801013:	29 e8                	sub    %ebp,%eax
  801015:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  ...
  801036:	75 0b                	jne    801043 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  801038:	b8 01 00 00 00       	mov    $0x1,%eax
  80103d:	31 d2                	xor    %edx,%edx
  80103f:	f7 f1                	div    %ecx
  ...
  80104b:	e9 3e ff ff ff       	jmp    800f8e <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  801057:	5d                   	pop    %ebp
  801058:	c3                   	ret    
  801059:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  80105c:	39 f5                	cmp    %esi,%ebp
  80105e:	72 04                	jb     801064 <__umoddi3+0x104>
  801060:	39 f9                	cmp    %edi,%ecx
  801062:	77 06                	ja     80106a <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801064:	89 f2                	mov    %esi,%edx
  801066:	29 cf                	sub    %ecx,%edi
  ...
  801076:	89 c5                	mov    %eax,%ebp
  801078:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  80107c:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801080:	eb 8d                	jmp    80100f <__umoddi3+0xaf>
  801082:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801084:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801088:	72 ea                	jb     801074 <__umoddi3+0x114>
  80108a:	89 f1                	mov    %esi,%ecx
  80108c:	eb 81                	jmp    80100f <__umoddi3+0xaf>
