...
umain(int argc, char **argv)
{
  ...
  800041:	e8 16 01 00 00       	call   80015c <cprintf>
  ...
  800059:	e8 fe 00 00 00       	call   80015c <cprintf>
}
  80005e:	c9                   	leave  
  80005f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006e:	e8 48 0a 00 00       	call   800abb <sys_getenvid>
  ...
  800097:	e8 98 ff ff ff       	call   800034 <umain>
	...
	// exit gracefully
	exit();
  80009c:	e8 07 00 00 00       	call   8000a8 <exit>
}
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d1:	e8 66 0c 00 00       	call   800e3c <__udivdi3>
  ...
  800224:	e8 33 0d 00 00       	call   800f5c <__umoddi3>
  800229:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80022d:	0f be 80 cf 10 80 00 	movsbl 0x8010cf(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 20 12 80 00 	jmp    *0x801220(,%edx,4)
  ...
  800408:	c7 44 24 08 f0 10 80 	movl   $0x8010f0,0x8(%esp)
  80040f:	00 
  ...
  80043c:	75 05                	jne    800443 <vprintfmt+0x185>
				p = "(null)";
  80043e:	be e0 10 80 00       	mov    $0x8010e0,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a96:	00 
  800a97:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800a9e:	00 
  800a9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aa6:	00 
  800aa7:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800aae:	e8 31 03 00 00       	call   800de4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b28:	00 
  800b29:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800b30:	00 
  800b31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b38:	00 
  800b39:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800b40:	e8 9f 02 00 00       	call   800de4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7b:	00 
  800b7c:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800b83:	00 
  800b84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8b:	00 
  800b8c:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800b93:	e8 4c 02 00 00       	call   800de4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bce:	00 
  800bcf:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800bd6:	00 
  800bd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bde:	00 
  800bdf:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800be6:	e8 f9 01 00 00       	call   800de4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c21:	00 
  800c22:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800c29:	00 
  800c2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c31:	00 
  800c32:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800c39:	e8 a6 01 00 00       	call   800de4 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c67:	7e 28                	jle    800c91 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800c69:	89 44 24 10          	mov    %eax,0x10(%esp)
  800c6d:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800c74:	00 
  800c75:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800c7c:	00 
  800c7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c84:	00 
  800c85:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800c8c:	e8 53 01 00 00       	call   800de4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cba:	7e 28                	jle    800ce4 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800cbc:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cc0:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800cc7:	00 
  800cc8:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800ccf:	00 
  800cd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd7:	00 
  800cd8:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800cdf:	e8 00 01 00 00       	call   800de4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d2f:	7e 28                	jle    800d59 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d31:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d35:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800d3c:	00 
  800d3d:	c7 44 24 08 e7 13 80 	movl   $0x8013e7,0x8(%esp)
  800d44:	00 
  800d45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4c:	00 
  800d4d:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800d54:	e8 8b 00 00 00       	call   800de4 <_panic>
...
sys_time_msec(void)
{
  ...
  800d6c:	b8 0e 00 00 00       	mov    $0xe,%eax
...
sys_e1000_get_mac(uint8_t* mac_addr){
  ...
  800dcd:	b8 11 00 00 00       	mov    $0x11,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800de9:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800dec:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800def:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800df5:	e8 c1 fc ff ff       	call   800abb <sys_getenvid>
  800dfa:	8b 55 0c             	mov    0xc(%ebp),%edx
  800dfd:	89 54 24 10          	mov    %edx,0x10(%esp)
  800e01:	8b 55 08             	mov    0x8(%ebp),%edx
  800e04:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e08:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800e0c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e10:	c7 04 24 14 14 80 00 	movl   $0x801414,(%esp)
  800e17:	e8 40 f3 ff ff       	call   80015c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e1c:	89 74 24 04          	mov    %esi,0x4(%esp)
  800e20:	8b 45 10             	mov    0x10(%ebp),%eax
  800e23:	89 04 24             	mov    %eax,(%esp)
  800e26:	e8 d0 f2 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800e2b:	c7 04 24 ac 10 80 00 	movl   $0x8010ac,(%esp)
  800e32:	e8 25 f3 ff ff       	call   80015c <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e37:	cc                   	int3   
  800e38:	eb fd                	jmp    800e37 <_panic+0x53>
	...
