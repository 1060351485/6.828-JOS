	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800221:	0f be 80 a8 10 80 00 	movsbl 0x8010a8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80033c:	ff 24 95 e0 11 80 00 	jmp    *0x8011e0(,%edx,4)
  ...
  8003fc:	c7 44 24 08 c9 10 80 	movl   $0x8010c9,0x8(%esp)
  800403:	00 
  ...
  800430:	75 05                	jne    800437 <vprintfmt+0x185>
				p = "(null)";
  800432:	be b9 10 80 00       	mov    $0x8010b9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a8a:	00 
  800a8b:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800a92:	00 
  800a93:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a9a:	00 
  800a9b:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b1c:	00 
  800b1d:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800b24:	00 
  800b25:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b2c:	00 
  800b2d:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b6f:	00 
  800b70:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800b77:	00 
  800b78:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b7f:	00 
  800b80:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d30:	00 
  800d31:	c7 44 24 08 a7 13 80 	movl   $0x8013a7,0x8(%esp)
  800d38:	00 
  800d39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d40:	00 
  800d41:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e04:	c7 04 24 d4 13 80 00 	movl   $0x8013d4,(%esp)
  ...
  800e1a:	e8 d0 f2 ff ff       	call   8000ef <vcprintf>
	cprintf("\n");
  800e1f:	c7 04 24 9c 10 80 00 	movl   $0x80109c,(%esp)
