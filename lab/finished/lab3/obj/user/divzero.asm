...
umain(int argc, char **argv)
{
  ...
  800055:	c7 04 24 80 0d 80 00 	movl   $0x800d80,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800221:	0f be 80 98 0d 80 00 	movsbl 0x800d98(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80033c:	ff 24 95 40 0e 80 00 	jmp    *0x800e40(,%edx,4)
  ...
  8003fc:	c7 44 24 08 b9 0d 80 	movl   $0x800db9,0x8(%esp)
  800403:	00 
  ...
  800430:	75 05                	jne    800437 <vprintfmt+0x185>
				p = "(null)";
  800432:	be a9 0d 80 00       	mov    $0x800da9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a8a:	00 
  800a8b:	c7 44 24 08 c0 0f 80 	movl   $0x800fc0,0x8(%esp)
  800a92:	00 
  800a93:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a9a:	00 
  800a9b:	c7 04 24 dd 0f 80 00 	movl   $0x800fdd,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800adb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  ...
  800afc:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
  ...
  800b12:	e8 d8 f5 ff ff       	call   8000ef <vcprintf>
	cprintf("\n");
  800b17:	c7 04 24 8c 0d 80 00 	movl   $0x800d8c,(%esp)
