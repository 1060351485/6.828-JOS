...
umain(int argc, char **argv)
{
  ...
  800043:	c7 04 24 80 0d 80 00 	movl   $0x800d80,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800211:	0f be 80 a8 0d 80 00 	movsbl 0x800da8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032c:	ff 24 95 40 0e 80 00 	jmp    *0x800e40(,%edx,4)
  ...
  8003ec:	c7 44 24 08 c9 0d 80 	movl   $0x800dc9,0x8(%esp)
  8003f3:	00 
  ...
  800420:	75 05                	jne    800427 <vprintfmt+0x185>
				p = "(null)";
  800422:	be b9 0d 80 00       	mov    $0x800db9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a7a:	00 
  800a7b:	c7 44 24 08 c0 0f 80 	movl   $0x800fc0,0x8(%esp)
  800a82:	00 
  800a83:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a8a:	00 
  800a8b:	c7 04 24 dd 0f 80 00 	movl   $0x800fdd,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800acb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  ...
  800aec:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
  ...
  800b02:	e8 d8 f5 ff ff       	call   8000df <vcprintf>
	cprintf("\n");
  800b07:	c7 04 24 9c 0d 80 00 	movl   $0x800d9c,(%esp)
