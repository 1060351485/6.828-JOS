...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  80003a:	c7 04 24 80 0d 80 00 	movl   $0x800d80,(%esp)
  ...
  800052:	c7 04 24 8e 0d 80 00 	movl   $0x800d8e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021d:	0f be 80 af 0d 80 00 	movsbl 0x800daf(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800338:	ff 24 95 40 0e 80 00 	jmp    *0x800e40(,%edx,4)
  ...
  8003f8:	c7 44 24 08 d0 0d 80 	movl   $0x800dd0,0x8(%esp)
  8003ff:	00 
  ...
  80042c:	75 05                	jne    800433 <vprintfmt+0x185>
				p = "(null)";
  80042e:	be c0 0d 80 00       	mov    $0x800dc0,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a86:	00 
  800a87:	c7 44 24 08 c0 0f 80 	movl   $0x800fc0,0x8(%esp)
  800a8e:	00 
  800a8f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a96:	00 
  800a97:	c7 04 24 dd 0f 80 00 	movl   $0x800fdd,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad7:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  ...
  800af8:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
  ...
  800b0e:	e8 d8 f5 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800b13:	c7 04 24 8c 0d 80 00 	movl   $0x800d8c,(%esp)
