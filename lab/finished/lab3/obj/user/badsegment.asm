...
libmain(int argc, char **argv)
{
  ...
  800049:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = envs;
  80004c:	c7 05 04 10 80 00 00 	movl   $0xeec00000,0x801004
  800053:	00 c0 ee 
...
sys_env_destroy(envid_t envid)
{
  ...
  8000f6:	00 
  8000f7:	c7 44 24 08 6a 0d 80 	movl   $0x800d6a,0x8(%esp)
  8000fe:	00 
  8000ff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800106:	00 
  800107:	c7 04 24 87 0d 80 00 	movl   $0x800d87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	c7 04 24 98 0d 80 00 	movl   $0x800d98,(%esp)
  ...
  80017e:	e8 50 00 00 00       	call   8001d3 <vcprintf>
	cprintf("\n");
  800183:	c7 04 24 bc 0d 80 00 	movl   $0x800dbc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800305:	0f be 80 be 0d 80 00 	movsbl 0x800dbe(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800420:	ff 24 95 60 0e 80 00 	jmp    *0x800e60(,%edx,4)
  ...
  8004e0:	c7 44 24 08 df 0d 80 	movl   $0x800ddf,0x8(%esp)
  8004e7:	00 
  ...
  800514:	75 05                	jne    80051b <vprintfmt+0x185>
				p = "(null)";
  800516:	be cf 0d 80 00       	mov    $0x800dcf,%esi
			if (width > 0 && padc != '-')
