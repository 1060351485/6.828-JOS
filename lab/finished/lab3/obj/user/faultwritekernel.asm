...
libmain(int argc, char **argv)
{
  ...
  80004d:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = envs;
  800050:	c7 05 04 10 80 00 00 	movl   $0xeec00000,0x801004
  800057:	00 c0 ee 
...
sys_env_destroy(envid_t envid)
{
  ...
  8000fa:	00 
  8000fb:	c7 44 24 08 6a 0d 80 	movl   $0x800d6a,0x8(%esp)
  800102:	00 
  800103:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80010a:	00 
  80010b:	c7 04 24 87 0d 80 00 	movl   $0x800d87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016c:	c7 04 24 98 0d 80 00 	movl   $0x800d98,(%esp)
  ...
  800182:	e8 50 00 00 00       	call   8001d7 <vcprintf>
	cprintf("\n");
  800187:	c7 04 24 bc 0d 80 00 	movl   $0x800dbc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800309:	0f be 80 be 0d 80 00 	movsbl 0x800dbe(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800424:	ff 24 95 60 0e 80 00 	jmp    *0x800e60(,%edx,4)
  ...
  8004e4:	c7 44 24 08 df 0d 80 	movl   $0x800ddf,0x8(%esp)
  8004eb:	00 
  ...
  800518:	75 05                	jne    80051f <vprintfmt+0x185>
				p = "(null)";
  80051a:	be cf 0d 80 00       	mov    $0x800dcf,%esi
			if (width > 0 && padc != '-')
