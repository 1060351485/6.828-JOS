	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800211:	0f be 80 b1 0d 80 00 	movsbl 0x800db1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003c9:	c7 44 24 08 c9 0d 80 	movl   $0x800dc9,0x8(%esp)
  8003d0:	00 
  ...
  8003ec:	c7 44 24 08 d2 0d 80 	movl   $0x800dd2,0x8(%esp)
  8003f3:	00 
  ...
  800420:	75 05                	jne    800427 <vprintfmt+0x185>
				p = "(null)";
  800422:	be c2 0d 80 00       	mov    $0x800dc2,%esi
			if (width > 0 && padc != '-')
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b02:	e8 d8 f5 ff ff       	call   8000df <vcprintf>
	cprintf("\n");
  800b07:	c7 04 24 10 10 80 00 	movl   $0x801010,(%esp)
