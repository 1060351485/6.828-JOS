...
libmain(int argc, char **argv)
{
  ...
  80005d:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = envs;
  800060:	c7 05 08 10 80 00 00 	movl   $0xeec00000,0x801008
  800067:	00 c0 ee 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010a:	00 
  80010b:	c7 44 24 08 98 0d 80 	movl   $0x800d98,0x8(%esp)
  800112:	00 
  800113:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011a:	00 
  80011b:	c7 04 24 b5 0d 80 00 	movl   $0x800db5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	c7 04 24 c4 0d 80 00 	movl   $0x800dc4,(%esp)
  ...
  800192:	e8 50 00 00 00       	call   8001e7 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 8c 0d 80 00 	movl   $0x800d8c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800319:	0f be 80 e8 0d 80 00 	movsbl 0x800de8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800434:	ff 24 95 80 0e 80 00 	jmp    *0x800e80(,%edx,4)
  ...
  8004f4:	c7 44 24 08 09 0e 80 	movl   $0x800e09,0x8(%esp)
  8004fb:	00 
  ...
  800528:	75 05                	jne    80052f <vprintfmt+0x185>
				p = "(null)";
  80052a:	be f9 0d 80 00       	mov    $0x800df9,%esi
			if (width > 0 && padc != '-')
