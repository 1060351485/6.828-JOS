...
libmain(int argc, char **argv)
{
  ...
  800059:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = envs;
  80005c:	c7 05 04 10 80 00 00 	movl   $0xeec00000,0x801004
  800063:	00 c0 ee 
...
sys_env_destroy(envid_t envid)
{
  ...
  800106:	00 
  800107:	c7 44 24 08 8a 0d 80 	movl   $0x800d8a,0x8(%esp)
  80010e:	00 
  80010f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800116:	00 
  800117:	c7 04 24 a7 0d 80 00 	movl   $0x800da7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800178:	c7 04 24 b8 0d 80 00 	movl   $0x800db8,(%esp)
  ...
  80018e:	e8 50 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800193:	c7 04 24 dc 0d 80 00 	movl   $0x800ddc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800315:	0f be 80 de 0d 80 00 	movsbl 0x800dde(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800430:	ff 24 95 80 0e 80 00 	jmp    *0x800e80(,%edx,4)
  ...
  8004f0:	c7 44 24 08 ff 0d 80 	movl   $0x800dff,0x8(%esp)
  8004f7:	00 
  ...
  800524:	75 05                	jne    80052b <vprintfmt+0x185>
				p = "(null)";
  800526:	be ef 0d 80 00       	mov    $0x800def,%esi
			if (width > 0 && padc != '-')
