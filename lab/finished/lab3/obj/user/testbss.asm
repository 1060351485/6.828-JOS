...
umain(int argc, char **argv)
{
  ...
  800059:	c7 44 24 08 9b 0e 80 	movl   $0x800e9b,0x8(%esp)
  800060:	00 
  800061:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800068:	00 
  800069:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000a3:	c7 44 24 08 40 0e 80 	movl   $0x800e40,0x8(%esp)
  8000aa:	00 
  8000ab:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b2:	00 
  8000b3:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800174:	c7 04 24 e8 0e 80 00 	movl   $0x800ee8,(%esp)
  ...
  80018a:	e8 50 00 00 00       	call   8001df <vcprintf>
	cprintf("\n");
  80018f:	c7 04 24 b6 0e 80 00 	movl   $0x800eb6,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800311:	0f be 80 0c 0f 80 00 	movsbl 0x800f0c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042c:	ff 24 95 a0 0f 80 00 	jmp    *0x800fa0(,%edx,4)
  ...
  8004ec:	c7 44 24 08 2d 0f 80 	movl   $0x800f2d,0x8(%esp)
  8004f3:	00 
  ...
  800520:	75 05                	jne    800527 <vprintfmt+0x185>
				p = "(null)";
  800522:	be 1d 0f 80 00       	mov    $0x800f1d,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b7a:	00 
  800b7b:	c7 44 24 08 20 11 80 	movl   $0x801120,0x8(%esp)
  800b82:	00 
  800b83:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8a:	00 
  800b8b:	c7 04 24 3d 11 80 00 	movl   $0x80113d,(%esp)
