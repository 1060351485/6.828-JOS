...
umain(int argc, char **argv)
{
  ...
  800043:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800048:	e8 32 0f 00 00       	call   800f7f <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002dd:	e8 2e 10 00 00       	call   801310 <__udivdi3>
  ...
  800330:	e8 fb 10 00 00       	call   801430 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800454:	ff 24 95 20 17 80 00 	jmp    *0x801720(,%edx,4)
  ...
  8004e2:	8b 04 85 80 18 80 00 	mov    0x801880(,%eax,4),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba2:	00 
  800ba3:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800baa:	00 
  800bab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb2:	00 
  800bb3:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c34:	00 
  800c35:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800c3c:	00 
  800c3d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c44:	00 
  800c45:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c87:	00 
  800c88:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800c8f:	00 
  800c90:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c97:	00 
  800c98:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cda:	00 
  800cdb:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800ce2:	00 
  800ce3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cea:	00 
  800ceb:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2d:	00 
  800d2e:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800d35:	00 
  800d36:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3d:	00 
  800d3e:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d80:	00 
  800d81:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800d88:	00 
  800d89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d90:	00 
  800d91:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dd3:	00 
  800dd4:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800ddb:	00 
  800ddc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de3:	00 
  800de4:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e48:	00 
  800e49:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800e50:	00 
  800e51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e58:	00 
  800e59:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e80:	75 20                	jne    800ea2 <pgfault+0x32>
		panic("pgfault: faulting address [%08x] not a write\n", addr);
  800e82:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800e86:	c7 44 24 08 0c 19 80 	movl   $0x80190c,0x8(%esp)
  800e8d:	00 
  800e8e:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  800e95:	00 
  800e96:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  800e9d:	e8 ce f2 ff ff       	call   800170 <_panic>
  ...
  800eb7:	75 1c                	jne    800ed5 <pgfault+0x65>
		panic("pgfault: fault was not on a copy-on-write page\n");
  800eb9:	c7 44 24 08 3c 19 80 	movl   $0x80193c,0x8(%esp)
  800ec0:	00 
  800ec1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec8:	00 
  800ec9:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  800ed0:	e8 9b f2 ff ff       	call   800170 <_panic>
  ...
  800ed5:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800edc:	00 
  800edd:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800ee4:	00 
  800ee5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800eec:	e8 14 fd ff ff       	call   800c05 <sys_page_alloc>
  800ef1:	85 c0                	test   %eax,%eax
  800ef3:	79 20                	jns    800f15 <pgfault+0xa5>
		panic("sys_page_alloc: %e\n", r);
  800ef5:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ef9:	c7 44 24 08 97 19 80 	movl   $0x801997,0x8(%esp)
  800f00:	00 
  800f01:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  800f08:	00 
  800f09:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  800f10:	e8 5b f2 ff ff       	call   800170 <_panic>

	// Copy over
	void *src_addr = (void *) ROUNDDOWN(addr, PGSIZE);
	memmove(PFTEMP, src_addr, PGSIZE);
  800f15:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f1c:	00 
  800f1d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f21:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f28:	e8 5f fa ff ff       	call   80098c <memmove>
  ...
  800f50:	e8 04 fd ff ff       	call   800c59 <sys_page_map>
  800f55:	85 c0                	test   %eax,%eax
  800f57:	79 20                	jns    800f79 <pgfault+0x109>
		panic("sys_page_map: %e\n", r);
  800f59:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f5d:	c7 44 24 08 ab 19 80 	movl   $0x8019ab,0x8(%esp)
  800f64:	00 
  800f65:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  800f6c:	00 
  800f6d:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  800f74:	e8 f7 f1 ff ff       	call   800170 <_panic>
...
fork(void)
{
  ...
  800f83:	56                   	push   %esi
  800f84:	53                   	push   %ebx
  800f85:	83 ec 3c             	sub    $0x3c,%esp
	// LAB 4: Your code here.
	int r;
	envid_t child_envid;

	set_pgfault_handler(pgfault);
  800f88:	c7 04 24 70 0e 80 00 	movl   $0x800e70,(%esp)
  800f8f:	e8 e4 02 00 00       	call   801278 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800f94:	ba 07 00 00 00       	mov    $0x7,%edx
  800f99:	89 d0                	mov    %edx,%eax
  800f9b:	cd 30                	int    $0x30
  800f9d:	89 45 dc             	mov    %eax,-0x24(%ebp)
  800fa0:	89 45 e0             	mov    %eax,-0x20(%ebp)

	child_envid = sys_exofork();
	if (child_envid < 0)
  800fa3:	85 c0                	test   %eax,%eax
  800fa5:	79 20                	jns    800fc7 <fork+0x48>
		panic("sys_exofork: %e\n", child_envid);
  800fa7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fab:	c7 44 24 08 bd 19 80 	movl   $0x8019bd,0x8(%esp)
  800fb2:	00 
  800fb3:	c7 44 24 04 82 00 00 	movl   $0x82,0x4(%esp)
  800fba:	00 
  800fbb:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  800fc2:	e8 a9 f1 ff ff       	call   800170 <_panic>
	if (child_envid == 0) { // child
  800fc7:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  800fcb:	75 25                	jne    800ff2 <fork+0x73>
		// Fix thisenv like dumbfork does and return 0
		thisenv = &envs[ENVX(sys_getenvid())];
  800fcd:	e8 f5 fb ff ff       	call   800bc7 <sys_getenvid>
  800fd2:	25 ff 03 00 00       	and    $0x3ff,%eax
  800fd7:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  800fde:	c1 e0 07             	shl    $0x7,%eax
  800fe1:	29 d0                	sub    %edx,%eax
  800fe3:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800fe8:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  800fed:	e9 58 02 00 00       	jmp    80124a <fork+0x2cb>
	set_pgfault_handler(pgfault);
  ...
  80100a:	0f 84 7a 01 00 00    	je     80118a <fork+0x20b>
  ...
  801019:	0f 84 6b 01 00 00    	je     80118a <fork+0x20b>
static int
duppage(envid_t envid, unsigned pn)
{
  ...
  801046:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  80104a:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80104d:	89 44 24 08          	mov    %eax,0x8(%esp)
  801051:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801055:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801058:	89 04 24             	mov    %eax,(%esp)
  80105b:	e8 f9 fb ff ff       	call   800c59 <sys_page_map>
  801060:	85 c0                	test   %eax,%eax
  801062:	0f 89 22 01 00 00    	jns    80118a <fork+0x20b>
			panic("sys_page_map: %e\n", r);
  801068:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80106c:	c7 44 24 08 ab 19 80 	movl   $0x8019ab,0x8(%esp)
  801073:	00 
  801074:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  80107b:	00 
  80107c:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  ...
  801092:	75 0f                	jne    8010a3 <fork+0x124>
  801094:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  80109b:	a8 02                	test   $0x2,%al
  80109d:	0f 84 99 00 00 00    	je     80113c <fork+0x1bd>
		if (uvpt[pn] & PTE_U)
  8010a3:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  8010aa:	83 e0 04             	and    $0x4,%eax
//
static int
duppage(envid_t envid, unsigned pn)
{
  ...
  8010b0:	19 db                	sbb    %ebx,%ebx
  8010b2:	83 e3 fc             	and    $0xfffffffc,%ebx
  ...
  8010bb:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  8010bf:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8010c3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  ...
  8010d4:	e8 80 fb ff ff       	call   800c59 <sys_page_map>
  8010d9:	85 c0                	test   %eax,%eax
  8010db:	79 20                	jns    8010fd <fork+0x17e>
			panic("sys_page_map: %e\n", r);
  8010dd:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010e1:	c7 44 24 08 ab 19 80 	movl   $0x8019ab,0x8(%esp)
  8010e8:	00 
  8010e9:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  8010f0:	00 
  8010f1:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  8010f8:	e8 73 f0 ff ff       	call   800170 <_panic>

		// Map page COW, U and P in parent
		if ((r = sys_page_map(this_envid, (void *) (pn*PGSIZE), this_envid, (void *) (pn*PGSIZE), perm)) < 0)
  8010fd:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  801101:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801105:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801108:	89 44 24 08          	mov    %eax,0x8(%esp)
  80110c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801110:	89 04 24             	mov    %eax,(%esp)
  801113:	e8 41 fb ff ff       	call   800c59 <sys_page_map>
  801118:	85 c0                	test   %eax,%eax
  80111a:	79 6e                	jns    80118a <fork+0x20b>
			panic("sys_page_map: %e\n", r);
  80111c:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801120:	c7 44 24 08 ab 19 80 	movl   $0x8019ab,0x8(%esp)
  801127:	00 
  801128:	c7 44 24 04 5d 00 00 	movl   $0x5d,0x4(%esp)
  80112f:	00 
  801130:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  801137:	e8 34 f0 ff ff       	call   800170 <_panic>

	} else { // map pages that are present but not writable or COW with their original permissions
		if ((r = sys_page_map(this_envid, (void *) (pn*PGSIZE), envid, (void *) (pn*PGSIZE), uvpt[pn] & PTE_SYSCALL)) < 0)
  80113c:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  801143:	25 07 0e 00 00       	and    $0xe07,%eax
  801148:	89 44 24 10          	mov    %eax,0x10(%esp)
  80114c:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801150:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801153:	89 44 24 08          	mov    %eax,0x8(%esp)
  801157:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80115b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80115e:	89 04 24             	mov    %eax,(%esp)
  801161:	e8 f3 fa ff ff       	call   800c59 <sys_page_map>
  801166:	85 c0                	test   %eax,%eax
  801168:	79 20                	jns    80118a <fork+0x20b>
			panic("sys_page_map: %e\n", r);
  80116a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80116e:	c7 44 24 08 ab 19 80 	movl   $0x8019ab,0x8(%esp)
  801175:	00 
  801176:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  80117d:	00 
  80117e:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  801185:	e8 e6 ef ff ff       	call   800170 <_panic>
	...
	for (page_num = 0; page_num < PGNUM(UTOP - PGSIZE); page_num++) {
  80118a:	46                   	inc    %esi
  80118b:	81 c7 00 10 00 00    	add    $0x1000,%edi
  801191:	81 fe ff eb 0e 00    	cmp    $0xeebff,%esi
  801197:	0f 85 5f fe ff ff    	jne    800ffc <fork+0x7d>
	}
  ...
  80119d:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  8011a4:	00 
  8011a5:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8011ac:	ee 
  8011ad:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8011b0:	89 04 24             	mov    %eax,(%esp)
  8011b3:	e8 4d fa ff ff       	call   800c05 <sys_page_alloc>
  8011b8:	85 c0                	test   %eax,%eax
  8011ba:	79 20                	jns    8011dc <fork+0x25d>
		panic("sys_page_alloc: %e\n", r);
  8011bc:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011c0:	c7 44 24 08 97 19 80 	movl   $0x801997,0x8(%esp)
  8011c7:	00 
  8011c8:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  8011cf:	00 
  8011d0:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  8011d7:	e8 94 ef ff ff       	call   800170 <_panic>

	// Set page fault handler for the child
	if ((r = sys_env_set_pgfault_upcall(child_envid, _pgfault_upcall)) < 0)
  8011dc:	c7 44 24 04 ec 12 80 	movl   $0x8012ec,0x4(%esp)
  8011e3:	00 
  8011e4:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8011e7:	89 04 24             	mov    %eax,(%esp)
  8011ea:	e8 b6 fb ff ff       	call   800da5 <sys_env_set_pgfault_upcall>
  8011ef:	85 c0                	test   %eax,%eax
  8011f1:	79 20                	jns    801213 <fork+0x294>
		panic("sys_env_set_pgfault_upcall: %e\n", r);
  8011f3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011f7:	c7 44 24 08 6c 19 80 	movl   $0x80196c,0x8(%esp)
  8011fe:	00 
  8011ff:	c7 44 24 04 a1 00 00 	movl   $0xa1,0x4(%esp)
  801206:	00 
  801207:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  80120e:	e8 5d ef ff ff       	call   800170 <_panic>

	// Mark child environment as runnable
	if ((r = sys_env_set_status(child_envid, ENV_RUNNABLE)) < 0)
  801213:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  80121a:	00 
  80121b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80121e:	89 04 24             	mov    %eax,(%esp)
  801221:	e8 d9 fa ff ff       	call   800cff <sys_env_set_status>
  801226:	85 c0                	test   %eax,%eax
  801228:	79 20                	jns    80124a <fork+0x2cb>
		panic("sys_env_set_status: %e\n", r);
  80122a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80122e:	c7 44 24 08 ce 19 80 	movl   $0x8019ce,0x8(%esp)
  801235:	00 
  801236:	c7 44 24 04 a5 00 00 	movl   $0xa5,0x4(%esp)
  80123d:	00 
  80123e:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  801245:	e8 26 ef ff ff       	call   800170 <_panic>
...
sfork(void)
{
  ...
  80125b:	c7 44 24 08 e6 19 80 	movl   $0x8019e6,0x8(%esp)
  801262:	00 
  801263:	c7 44 24 04 ae 00 00 	movl   $0xae,0x4(%esp)
  80126a:	00 
  80126b:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
  801272:	e8 f9 ee ff ff       	call   800170 <_panic>
	...
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80127e:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  801285:	75 58                	jne    8012df <set_pgfault_handler+0x67>
		// First time through!
		// LAB 4: Your code here.	
		//panic("set_pgfault_handler not implemented");
		
		if (sys_page_alloc(thisenv->env_id,(void *) (UXSTACKTOP - PGSIZE),(PTE_W|PTE_U|PTE_P)) != 0){
  801287:	a1 08 20 80 00       	mov    0x802008,%eax
  ...
  8012a2:	e8 5e f9 ff ff       	call   800c05 <sys_page_alloc>
  8012a7:	85 c0                	test   %eax,%eax
  8012a9:	74 1c                	je     8012c7 <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  8012ab:	c7 44 24 08 fc 19 80 	movl   $0x8019fc,0x8(%esp)
  8012b2:	00 
  8012b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012ba:	00 
  8012bb:	c7 04 24 11 1a 80 00 	movl   $0x801a11,(%esp)
  8012c2:	e8 a9 ee ff ff       	call   800170 <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  8012c7:	a1 08 20 80 00       	mov    0x802008,%eax
  8012cc:	8b 40 48             	mov    0x48(%eax),%eax
  8012cf:	c7 44 24 04 ec 12 80 	movl   $0x8012ec,0x4(%esp)
  8012d6:	00 
  8012d7:	89 04 24             	mov    %eax,(%esp)
  8012da:	e8 c6 fa ff ff       	call   800da5 <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  8012df:	8b 45 08             	mov    0x8(%ebp),%eax
  8012e2:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  8012e7:	c9                   	leave  
  8012e8:	c3                   	ret    
  8012e9:	00 00                	add    %al,(%eax)
	...

008012ec <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  8012ed:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  8012f4:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  8012f7:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  8012fb:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  8012fd:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  801301:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  801302:	89 65 30             	mov    %esp,0x30(%ebp)
