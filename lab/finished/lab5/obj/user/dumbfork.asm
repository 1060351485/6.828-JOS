...
duppage(envid_t dstenv, void *addr)
{
  ...
  80005e:	c7 44 24 08 00 12 80 	movl   $0x801200,0x8(%esp)
  800065:	00 
  800066:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  80006d:	00 
  80006e:	c7 04 24 13 12 80 00 	movl   $0x801213,(%esp)
  ...
  8000a6:	c7 44 24 08 23 12 80 	movl   $0x801223,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 13 12 80 00 	movl   $0x801213,(%esp)
  ...
  8000f6:	c7 44 24 08 34 12 80 	movl   $0x801234,0x8(%esp)
  8000fd:	00 
  8000fe:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  800105:	00 
  800106:	c7 04 24 13 12 80 00 	movl   $0x801213,(%esp)
...
sys_exofork(void)
{
  ...
  800136:	c7 44 24 08 47 12 80 	movl   $0x801247,0x8(%esp)
  80013d:	00 
  80013e:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  800145:	00 
  800146:	c7 04 24 13 12 80 00 	movl   $0x801213,(%esp)
  ...
  8001ca:	c7 44 24 08 57 12 80 	movl   $0x801257,0x8(%esp)
  8001d1:	00 
  8001d2:	c7 44 24 04 4c 00 00 	movl   $0x4c,0x4(%esp)
  8001d9:	00 
  8001da:	c7 04 24 13 12 80 00 	movl   $0x801213,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800209:	b8 6e 12 80 00       	mov    $0x80126e,%eax
  80020e:	eb 05                	jmp    800215 <umain+0x26>
  800210:	b8 75 12 80 00       	mov    $0x801275,%eax
  800215:	89 44 24 08          	mov    %eax,0x8(%esp)
  800219:	89 74 24 04          	mov    %esi,0x4(%esp)
  80021d:	c7 04 24 7b 12 80 00 	movl   $0x80127b,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002dc:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
  ...
  8002f2:	e8 50 00 00 00       	call   800347 <vcprintf>
	cprintf("\n");
  8002f7:	c7 04 24 8b 12 80 00 	movl   $0x80128b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80041d:	e8 8e 0b 00 00       	call   800fb0 <__udivdi3>
  ...
  800470:	e8 5b 0c 00 00       	call   8010d0 <__umoddi3>
  800475:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800479:	0f be 80 bb 12 80 00 	movsbl 0x8012bb(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800594:	ff 24 95 00 14 80 00 	jmp    *0x801400(,%edx,4)
  ...
  800654:	c7 44 24 08 dc 12 80 	movl   $0x8012dc,0x8(%esp)
  80065b:	00 
  ...
  800688:	75 05                	jne    80068f <vprintfmt+0x185>
				p = "(null)";
  80068a:	be cc 12 80 00       	mov    $0x8012cc,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ce2:	00 
  800ce3:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800cea:	00 
  800ceb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf2:	00 
  800cf3:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d74:	00 
  800d75:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800d7c:	00 
  800d7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d84:	00 
  800d85:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dc7:	00 
  800dc8:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800dcf:	00 
  800dd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd7:	00 
  800dd8:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e1a:	00 
  800e1b:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800e22:	00 
  800e23:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2a:	00 
  800e2b:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e6d:	00 
  800e6e:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800e75:	00 
  800e76:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e7d:	00 
  800e7e:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ec0:	00 
  800ec1:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800ec8:	00 
  800ec9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ed0:	00 
  800ed1:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f13:	00 
  800f14:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800f1b:	00 
  800f1c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f23:	00 
  800f24:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
  800f2b:	e8 80 f3 ff ff       	call   8002b0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f88:	00 
  800f89:	c7 44 24 08 c0 15 80 	movl   $0x8015c0,0x8(%esp)
  800f90:	00 
  800f91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f98:	00 
  800f99:	c7 04 24 dd 15 80 00 	movl   $0x8015dd,(%esp)
  800fa0:	e8 0b f3 ff ff       	call   8002b0 <_panic>
