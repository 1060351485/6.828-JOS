...
umain(int argc, char **argv)
{
  ...
  800075:	e8 1e 0d 00 00       	call   800d98 <set_pgfault_handler>
	*(int*)0xDeadBeef = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800205:	e8 7e 0c 00 00       	call   800e88 <__udivdi3>
  ...
  800258:	e8 4b 0d 00 00       	call   800fa8 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037c:	ff 24 95 40 12 80 00 	jmp    *0x801240(,%edx,4)
  ...
  80040a:	8b 04 85 a0 13 80 00 	mov    0x8013a0(,%eax,4),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800aca:	00 
  800acb:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800ad2:	00 
  800ad3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ada:	00 
  800adb:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800ae2:	e8 49 03 00 00       	call   800e30 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b5c:	00 
  800b5d:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800b64:	00 
  800b65:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b6c:	00 
  800b6d:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800b74:	e8 b7 02 00 00       	call   800e30 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800baf:	00 
  800bb0:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800bb7:	00 
  800bb8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bbf:	00 
  800bc0:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800bc7:	e8 64 02 00 00       	call   800e30 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800c1a:	e8 11 02 00 00       	call   800e30 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800c6d:	e8 be 01 00 00       	call   800e30 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800cc0:	e8 6b 01 00 00       	call   800e30 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800d13:	e8 18 01 00 00       	call   800e30 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d70:	00 
  800d71:	c7 44 24 08 ff 13 80 	movl   $0x8013ff,0x8(%esp)
  800d78:	00 
  800d79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d80:	00 
  800d81:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  800d88:	e8 a3 00 00 00       	call   800e30 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800da5:	75 58                	jne    800dff <set_pgfault_handler+0x67>
		// First time through!
		// LAB 4: Your code here.	
		//panic("set_pgfault_handler not implemented");
		
		if (sys_page_alloc(thisenv->env_id,(void *) (UXSTACKTOP - PGSIZE),(PTE_W|PTE_U|PTE_P)) != 0){
  800da7:	a1 04 20 80 00       	mov    0x802004,%eax
  800dac:	8b 40 48             	mov    0x48(%eax),%eax
  800daf:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800db6:	00 
  800db7:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800dbe:	ee 
  800dbf:	89 04 24             	mov    %eax,(%esp)
  800dc2:	e8 66 fd ff ff       	call   800b2d <sys_page_alloc>
  800dc7:	85 c0                	test   %eax,%eax
  800dc9:	74 1c                	je     800de7 <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  800dcb:	c7 44 24 08 2a 14 80 	movl   $0x80142a,0x8(%esp)
  800dd2:	00 
  800dd3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dda:	00 
  800ddb:	c7 04 24 3f 14 80 00 	movl   $0x80143f,(%esp)
  800de2:	e8 49 00 00 00       	call   800e30 <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800de7:	a1 04 20 80 00       	mov    0x802004,%eax
  800dec:	8b 40 48             	mov    0x48(%eax),%eax
  800def:	c7 44 24 04 0c 0e 80 	movl   $0x800e0c,0x4(%esp)
  800df6:	00 
  800df7:	89 04 24             	mov    %eax,(%esp)
  800dfa:	e8 ce fe ff ff       	call   800ccd <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800dff:	8b 45 08             	mov    0x8(%ebp),%eax
  800e02:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e07:	c9                   	leave  
  800e08:	c3                   	ret    
...
_pgfault_upcall:
  ...
  800e0d:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e14:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800e17:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  800e1b:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  800e1d:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  800e21:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800e22:	89 65 30             	mov    %esp,0x30(%ebp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e35:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800e38:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e3b:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800e41:	e8 a9 fc ff ff       	call   800aef <sys_getenvid>
  800e46:	8b 55 0c             	mov    0xc(%ebp),%edx
  800e49:	89 54 24 10          	mov    %edx,0x10(%esp)
  800e4d:	8b 55 08             	mov    0x8(%ebp),%edx
  800e50:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e54:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800e58:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e5c:	c7 04 24 50 14 80 00 	movl   $0x801450,(%esp)
  800e63:	e8 28 f3 ff ff       	call   800190 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e68:	89 74 24 04          	mov    %esi,0x4(%esp)
  800e6c:	8b 45 10             	mov    0x10(%ebp),%eax
  800e6f:	89 04 24             	mov    %eax,(%esp)
  800e72:	e8 b8 f2 ff ff       	call   80012f <vcprintf>
	cprintf("\n");
  800e77:	c7 04 24 fa 10 80 00 	movl   $0x8010fa,(%esp)
  800e7e:	e8 0d f3 ff ff       	call   800190 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e83:	cc                   	int3   
  800e84:	eb fd                	jmp    800e83 <_panic+0x53>
	...
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e8e:	8b 74 24 20          	mov    0x20(%esp),%esi
  800e92:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800e9a:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800e9e:	89 cd                	mov    %ecx,%ebp
  800ea0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800ea6:	75 2c                	jne    800ed4 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800ea8:	39 f9                	cmp    %edi,%ecx
  800eaa:	77 68                	ja     800f14 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800eae:	75 0b                	jne    800ebb <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800ed6:	77 2c                	ja     800f04 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800ed8:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800edb:	83 f6 1f             	xor    $0x1f,%esi
  800ede:	75 4c                	jne    800f2c <__udivdi3+0xa4>
  ...
  800ee2:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800ee7:	72 0a                	jb     800ef3 <__udivdi3+0x6b>
  800ee9:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800eed:	0f 87 ad 00 00 00    	ja     800fa0 <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800ef3:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f30:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  800f34:	b8 20 00 00 00       	mov    $0x20,%eax
  ...
  800f41:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800f45:	09 ca                	or     %ecx,%edx
  800f47:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800f4b:	89 f1                	mov    %esi,%ecx
  800f4d:	d3 e5                	shl    %cl,%ebp
  800f4f:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800f53:	89 fd                	mov    %edi,%ebp
  800f55:	88 c1                	mov    %al,%cl
  800f57:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800f59:	89 fa                	mov    %edi,%edx
  800f5b:	89 f1                	mov    %esi,%ecx
  800f5d:	d3 e2                	shl    %cl,%edx
  800f5f:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f63:	88 c1                	mov    %al,%cl
  800f65:	d3 ef                	shr    %cl,%edi
  800f67:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f69:	89 f8                	mov    %edi,%eax
  800f6b:	89 ea                	mov    %ebp,%edx
  800f6d:	f7 74 24 08          	divl   0x8(%esp)
  ...
  800f7b:	72 17                	jb     800f94 <__udivdi3+0x10c>
  800f7d:	74 09                	je     800f88 <__udivdi3+0x100>
  800f7f:	89 fe                	mov    %edi,%esi
  800f81:	31 ff                	xor    %edi,%edi
  800f83:	e9 41 ff ff ff       	jmp    800ec9 <__udivdi3+0x41>
  ...
  800f92:	73 eb                	jae    800f7f <__udivdi3+0xf7>
		{
		  q0--;
  800f94:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f97:	31 ff                	xor    %edi,%edi
  800f99:	e9 2b ff ff ff       	jmp    800ec9 <__udivdi3+0x41>
  800f9e:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800fa0:	31 f6                	xor    %esi,%esi
  800fa2:	e9 22 ff ff ff       	jmp    800ec9 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800fae:	8b 44 24 30          	mov    0x30(%esp),%eax
  800fb2:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800fb6:	89 44 24 14          	mov    %eax,0x14(%esp)
  800fba:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800fbe:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800fc2:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800fca:	85 ed                	test   %ebp,%ebp
  800fcc:	75 16                	jne    800fe4 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800fce:	39 f1                	cmp    %esi,%ecx
  800fd0:	0f 86 a6 00 00 00    	jbe    80107c <__umoddi3+0xd4>
  ...
  800fe6:	0f 87 ac 00 00 00    	ja     801098 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800ff6:	0f 84 a8 00 00 00    	je     8010a4 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800ffc:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801000:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  801002:	bf 20 00 00 00       	mov    $0x20,%edi
  801007:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  80100b:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80100f:	89 f9                	mov    %edi,%ecx
  801011:	d3 e8                	shr    %cl,%eax
  801013:	09 e8                	or     %ebp,%eax
  801015:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801019:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80101d:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801029:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  80102b:	8b 44 24 14          	mov    0x14(%esp),%eax
  80102f:	d3 e0                	shl    %cl,%eax
  801031:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  801035:	8b 44 24 14          	mov    0x14(%esp),%eax
  801039:	89 f9                	mov    %edi,%ecx
  80103b:	d3 e8                	shr    %cl,%eax
  80103d:	09 d0                	or     %edx,%eax
  ...
  801043:	f7 74 24 18          	divl   0x18(%esp)
  801047:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801049:	f7 64 24 0c          	mull   0xc(%esp)
  80104d:	89 c5                	mov    %eax,%ebp
  80104f:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801051:	39 d6                	cmp    %edx,%esi
  801053:	72 67                	jb     8010bc <__umoddi3+0x114>
  801055:	74 75                	je     8010cc <__umoddi3+0x124>
	      q1 = 0;
  ...
  80105b:	29 e8                	sub    %ebp,%eax
  80105d:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  80105f:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801063:	d3 e8                	shr    %cl,%eax
  801065:	89 f2                	mov    %esi,%edx
  801067:	89 f9                	mov    %edi,%ecx
  801069:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  80106b:	09 d0                	or     %edx,%eax
  80106d:	89 f2                	mov    %esi,%edx
  80106f:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  80107e:	75 0b                	jne    80108b <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  801093:	e9 3e ff ff ff       	jmp    800fd6 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  8010a6:	72 04                	jb     8010ac <__umoddi3+0x104>
  8010a8:	39 f9                	cmp    %edi,%ecx
  8010aa:	77 06                	ja     8010b2 <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  8010ac:	89 f2                	mov    %esi,%edx
  8010ae:	29 cf                	sub    %ecx,%edi
  8010b0:	19 ea                	sbb    %ebp,%edx
  ...
  8010be:	89 c5                	mov    %eax,%ebp
  8010c0:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  8010c4:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  8010c8:	eb 8d                	jmp    801057 <__umoddi3+0xaf>
  8010ca:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010cc:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010d0:	72 ea                	jb     8010bc <__umoddi3+0x114>
  8010d2:	89 f1                	mov    %esi,%ecx
  8010d4:	eb 81                	jmp    801057 <__umoddi3+0xaf>
