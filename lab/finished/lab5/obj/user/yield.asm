...
umain(int argc, char **argv)
{
  ...
  800047:	c7 04 24 60 10 80 00 	movl   $0x801060,(%esp)
  ...
  80006d:	c7 04 24 80 10 80 00 	movl   $0x801080,(%esp)
...
umain(int argc, char **argv)
{
  ...
  80008b:	c7 04 24 ac 10 80 00 	movl   $0x8010ac,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021d:	e8 e6 0b 00 00       	call   800e08 <__udivdi3>
  ...
  800270:	e8 b3 0c 00 00       	call   800f28 <__umoddi3>
  800275:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800279:	0f be 80 d5 10 80 00 	movsbl 0x8010d5(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800394:	ff 24 95 20 12 80 00 	jmp    *0x801220(,%edx,4)
  ...
  800454:	c7 44 24 08 f6 10 80 	movl   $0x8010f6,0x8(%esp)
  80045b:	00 
  ...
  800488:	75 05                	jne    80048f <vprintfmt+0x185>
				p = "(null)";
  80048a:	be e6 10 80 00       	mov    $0x8010e6,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae2:	00 
  800ae3:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800aea:	00 
  800aeb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800af2:	00 
  800af3:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800afa:	e8 b1 02 00 00       	call   800db0 <_panic>
...
sys_yield(void)
{
  ...
  800b31:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b74:	00 
  800b75:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800b7c:	00 
  800b7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b84:	00 
  800b85:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800b8c:	e8 1f 02 00 00       	call   800db0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc7:	00 
  800bc8:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800bcf:	00 
  800bd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd7:	00 
  800bd8:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800bdf:	e8 cc 01 00 00       	call   800db0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1a:	00 
  800c1b:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800c22:	00 
  800c23:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c2a:	00 
  800c2b:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800c32:	e8 79 01 00 00       	call   800db0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c6d:	00 
  800c6e:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800c75:	00 
  800c76:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c7d:	00 
  800c7e:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800c85:	e8 26 01 00 00       	call   800db0 <_panic>
...
00800c92 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cb3:	7e 28                	jle    800cdd <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800cb5:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cb9:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800cc8:	00 
  800cc9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd0:	00 
  800cd1:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800cd8:	e8 d3 00 00 00       	call   800db0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d06:	7e 28                	jle    800d30 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d08:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d0c:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800d13:	00 
  800d14:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800d1b:	00 
  800d1c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d23:	00 
  800d24:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800d2b:	e8 80 00 00 00       	call   800db0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d7b:	7e 28                	jle    800da5 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d7d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d81:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800d88:	00 
  800d89:	c7 44 24 08 df 13 80 	movl   $0x8013df,0x8(%esp)
  800d90:	00 
  800d91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d98:	00 
  800d99:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  800da0:	e8 0b 00 00 00       	call   800db0 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800db5:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800db8:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800dbb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800dc1:	e8 41 fd ff ff       	call   800b07 <sys_getenvid>
  800dc6:	8b 55 0c             	mov    0xc(%ebp),%edx
  800dc9:	89 54 24 10          	mov    %edx,0x10(%esp)
  800dcd:	8b 55 08             	mov    0x8(%ebp),%edx
  800dd0:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800dd4:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800dd8:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ddc:	c7 04 24 0c 14 80 00 	movl   $0x80140c,(%esp)
  800de3:	e8 c0 f3 ff ff       	call   8001a8 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800de8:	89 74 24 04          	mov    %esi,0x4(%esp)
  800dec:	8b 45 10             	mov    0x10(%ebp),%eax
  800def:	89 04 24             	mov    %eax,(%esp)
  800df2:	e8 50 f3 ff ff       	call   800147 <vcprintf>
	cprintf("\n");
  800df7:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  800dfe:	e8 a5 f3 ff ff       	call   8001a8 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e03:	cc                   	int3   
  800e04:	eb fd                	jmp    800e03 <_panic+0x53>
	...
