...
umain(int argc, char **argv)
{
  ...
  8000c6:	e8 81 0d 00 00       	call   800e4c <set_pgfault_handler>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b9:	e8 26 0c 00 00       	call   800ee4 <__udivdi3>
  ...
  80030c:	e8 f3 0c 00 00       	call   801004 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800430:	ff 24 95 20 13 80 00 	jmp    *0x801320(,%edx,4)
  ...
  8004be:	8b 04 85 80 14 80 00 	mov    0x801480(,%eax,4),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b7e:	00 
  800b7f:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800b86:	00 
  800b87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8e:	00 
  800b8f:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c63:	00 
  800c64:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800c6b:	00 
  800c6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c73:	00 
  800c74:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb6:	00 
  800cb7:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800cbe:	00 
  800cbf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc6:	00 
  800cc7:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d09:	00 
  800d0a:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800d11:	00 
  800d12:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d19:	00 
  800d1a:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d5c:	00 
  800d5d:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800d64:	00 
  800d65:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6c:	00 
  800d6d:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800daf:	00 
  800db0:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800db7:	00 
  800db8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbf:	00 
  800dc0:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  800dc7:	e8 80 f3 ff ff       	call   80014c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e24:	00 
  800e25:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  800e2c:	00 
  800e2d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e34:	00 
  800e35:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  800e3c:	e8 0b f3 ff ff       	call   80014c <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e52:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e59:	75 58                	jne    800eb3 <set_pgfault_handler+0x67>
		// First time through!
  ...
  800e76:	e8 66 fd ff ff       	call   800be1 <sys_page_alloc>
  800e7b:	85 c0                	test   %eax,%eax
  800e7d:	74 1c                	je     800e9b <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  800e7f:	c7 44 24 08 0b 15 80 	movl   $0x80150b,0x8(%esp)
  800e86:	00 
  800e87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e8e:	00 
  800e8f:	c7 04 24 20 15 80 00 	movl   $0x801520,(%esp)
  800e96:	e8 b1 f2 ff ff       	call   80014c <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800e9b:	a1 04 20 80 00       	mov    0x802004,%eax
  800ea0:	8b 40 48             	mov    0x48(%eax),%eax
  800ea3:	c7 44 24 04 c0 0e 80 	movl   $0x800ec0,0x4(%esp)
  800eaa:	00 
  800eab:	89 04 24             	mov    %eax,(%esp)
  800eae:	e8 ce fe ff ff       	call   800d81 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800ec1:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800ec8:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800ecb:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  800ecf:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  800ed1:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  800ed5:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800ed6:	89 65 30             	mov    %esp,0x30(%ebp)
