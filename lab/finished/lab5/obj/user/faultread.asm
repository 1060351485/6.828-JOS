	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022d:	0f be 80 48 10 80 00 	movsbl 0x801048(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 80 11 80 00 	jmp    *0x801180(,%edx,4)
  ...
  800408:	c7 44 24 08 69 10 80 	movl   $0x801069,0x8(%esp)
  80040f:	00 
  ...
  80043c:	75 05                	jne    800443 <vprintfmt+0x185>
				p = "(null)";
  80043e:	be 59 10 80 00       	mov    $0x801059,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a96:	00 
  800a97:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800a9e:	00 
  800a9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aa6:	00 
  800aa7:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b28:	00 
  800b29:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800b30:	00 
  800b31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b38:	00 
  800b39:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7b:	00 
  800b7c:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800b83:	00 
  800b84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8b:	00 
  800b8c:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bce:	00 
  800bcf:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800bd6:	00 
  800bd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bde:	00 
  800bdf:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c21:	00 
  800c22:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800c29:	00 
  800c2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c31:	00 
  800c32:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c74:	00 
  800c75:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800c7c:	00 
  800c7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c84:	00 
  800c85:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cc7:	00 
  800cc8:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800ccf:	00 
  800cd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd7:	00 
  800cd8:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3c:	00 
  800d3d:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800d44:	00 
  800d45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4c:	00 
  800d4d:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d90:	c7 04 24 6c 13 80 00 	movl   $0x80136c,(%esp)
