...
pgfault(struct UTrapframe *utf)
{
  ...
  8003e5:	c7 44 24 04 3f 16 80 	movl   $0x80163f,0x4(%esp)
  8003ec:	00 
  8003ed:	c7 04 24 4d 16 80 00 	movl   $0x80164d,(%esp)
  8003f4:	b9 a0 20 80 00       	mov    $0x8020a0,%ecx
  8003f9:	ba 38 16 80 00       	mov    $0x801638,%edx
  ...
  80042c:	c7 44 24 08 54 16 80 	movl   $0x801654,0x8(%esp)
  800433:	00 
  800434:	c7 44 24 04 5c 00 00 	movl   $0x5c,0x4(%esp)
  80043b:	00 
  80043c:	c7 04 24 27 16 80 00 	movl   $0x801627,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800525:	c7 04 24 b4 16 80 00 	movl   $0x8016b4,(%esp)
  ...
  80053b:	c7 44 24 04 67 16 80 	movl   $0x801667,0x4(%esp)
  800542:	00 
  800543:	c7 04 24 78 16 80 00 	movl   $0x801678,(%esp)
  80054a:	b9 60 20 80 00       	mov    $0x802060,%ecx
  80054f:	ba 38 16 80 00       	mov    $0x801638,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8005f4:	c7 04 24 e0 16 80 00 	movl   $0x8016e0,(%esp)
  ...
  80060a:	e8 50 00 00 00       	call   80065f <vcprintf>
	cprintf("\n");
  80060f:	c7 04 24 f0 15 80 00 	movl   $0x8015f0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800735:	e8 26 0c 00 00       	call   801360 <__udivdi3>
  ...
  800788:	e8 f3 0c 00 00       	call   801480 <__umoddi3>
  80078d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800791:	0f be 80 03 17 80 00 	movsbl 0x801703(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008ac:	ff 24 95 40 18 80 00 	jmp    *0x801840(,%edx,4)
  ...
  80096c:	c7 44 24 08 24 17 80 	movl   $0x801724,0x8(%esp)
  800973:	00 
  ...
  8009a0:	75 05                	jne    8009a7 <vprintfmt+0x185>
				p = "(null)";
  8009a2:	be 14 17 80 00       	mov    $0x801714,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ffa:	00 
  800ffb:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  801002:	00 
  801003:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80100a:	00 
  80100b:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
sys_yield(void)
{
  ...
  801049:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80108c:	00 
  80108d:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  801094:	00 
  801095:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80109c:	00 
  80109d:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8010df:	00 
  8010e0:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  8010e7:	00 
  8010e8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010ef:	00 
  8010f0:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801132:	00 
  801133:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  80113a:	00 
  80113b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801142:	00 
  801143:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  801185:	00 
  801186:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  80118d:	00 
  80118e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801195:	00 
  801196:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
008011aa <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8011cb:	7e 28                	jle    8011f5 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8011cd:	89 44 24 10          	mov    %eax,0x10(%esp)
  8011d1:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8011d8:	00 
  8011d9:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  8011e0:	00 
  8011e1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011e8:	00 
  8011e9:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
...
008011fd <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80120b:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80121e:	7e 28                	jle    801248 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  801220:	89 44 24 10          	mov    %eax,0x10(%esp)
  801224:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80122b:	00 
  80122c:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  801233:	00 
  801234:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80123b:	00 
  80123c:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
  801243:	e8 80 f3 ff ff       	call   8005c8 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  801255:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  801256:	be 00 00 00 00       	mov    $0x0,%esi
  80125b:	b8 0c 00 00 00       	mov    $0xc,%eax
  801260:	8b 7d 14             	mov    0x14(%ebp),%edi
  801263:	8b 5d 10             	mov    0x10(%ebp),%ebx
...
sys_ipc_recv(void *dstva)
{
  ...
  801279:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  80127c:	b9 00 00 00 00       	mov    $0x0,%ecx
  801281:	b8 0d 00 00 00       	mov    $0xd,%eax
  801286:	8b 55 08             	mov    0x8(%ebp),%edx
  801289:	89 cb                	mov    %ecx,%ebx
  80128b:	89 cf                	mov    %ecx,%edi
  80128d:	89 ce                	mov    %ecx,%esi
  ...
  801293:	7e 28                	jle    8012bd <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  801295:	89 44 24 10          	mov    %eax,0x10(%esp)
  801299:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8012a0:	00 
  8012a1:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  8012a8:	00 
  8012a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012b0:	00 
  8012b1:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
  8012b8:	e8 0b f3 ff ff       	call   8005c8 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012f2:	e8 66 fd ff ff       	call   80105d <sys_page_alloc>
  8012f7:	85 c0                	test   %eax,%eax
  8012f9:	74 1c                	je     801317 <set_pgfault_handler+0x4f>
			panic("set_pg_fault_handler");
  8012fb:	c7 44 24 08 2b 1a 80 	movl   $0x801a2b,0x8(%esp)
  801302:	00 
  801303:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80130a:	00 
  80130b:	c7 04 24 40 1a 80 00 	movl   $0x801a40,(%esp)
  801312:	e8 b1 f2 ff ff       	call   8005c8 <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801317:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  80131c:	8b 40 48             	mov    0x48(%eax),%eax
  80131f:	c7 44 24 04 3c 13 80 	movl   $0x80133c,0x4(%esp)
  801326:	00 
  801327:	89 04 24             	mov    %eax,(%esp)
  80132a:	e8 ce fe ff ff       	call   8011fd <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  801344:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  801347:	8b 44 24 28          	mov    0x28(%esp),%eax
  ...
  80134b:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp), %esp
  80134d:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  801351:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  801352:	89 65 30             	mov    %esp,0x30(%ebp)
