	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001dd:	e8 e6 0b 00 00       	call   800dc8 <__udivdi3>
  ...
  800230:	e8 b3 0c 00 00       	call   800ee8 <__umoddi3>
  800235:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800239:	0f be 80 4f 10 80 00 	movsbl 0x80104f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800354:	ff 24 95 a0 11 80 00 	jmp    *0x8011a0(,%edx,4)
  ...
  800414:	c7 44 24 08 70 10 80 	movl   $0x801070,0x8(%esp)
  80041b:	00 
  ...
  800448:	75 05                	jne    80044f <vprintfmt+0x185>
				p = "(null)";
  80044a:	be 60 10 80 00       	mov    $0x801060,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aa2:	00 
  800aa3:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800aaa:	00 
  800aab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ab2:	00 
  800ab3:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b34:	00 
  800b35:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800b3c:	00 
  800b3d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b44:	00 
  800b45:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b87:	00 
  800b88:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800b8f:	00 
  800b90:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b97:	00 
  800b98:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bda:	00 
  800bdb:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800be2:	00 
  800be3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bea:	00 
  800beb:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c2d:	00 
  800c2e:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800c35:	00 
  800c36:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c3d:	00 
  800c3e:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cd3:	00 
  800cd4:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800cdb:	00 
  800cdc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce3:	00 
  800ce4:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
  800ceb:	e8 80 00 00 00       	call   800d70 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d9c:	c7 04 24 8c 13 80 00 	movl   $0x80138c,(%esp)
  800da3:	e8 c0 f3 ff ff       	call   800168 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800da8:	89 74 24 04          	mov    %esi,0x4(%esp)
  800dac:	8b 45 10             	mov    0x10(%ebp),%eax
  800daf:	89 04 24             	mov    %eax,(%esp)
  800db2:	e8 50 f3 ff ff       	call   800107 <vcprintf>
	cprintf("\n");
  800db7:	c7 04 24 2c 10 80 00 	movl   $0x80102c,(%esp)
  800dbe:	e8 a5 f3 ff ff       	call   800168 <cprintf>
