	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d1:	e8 e6 0b 00 00       	call   800dbc <__udivdi3>
  ...
  800224:	e8 b3 0c 00 00       	call   800edc <__umoddi3>
  800229:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80022d:	0f be 80 51 10 80 00 	movsbl 0x801051(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 a0 11 80 00 	jmp    *0x8011a0(,%edx,4)
  ...
  800408:	c7 44 24 08 72 10 80 	movl   $0x801072,0x8(%esp)
  80040f:	00 
  ...
  80043c:	75 05                	jne    800443 <vprintfmt+0x185>
				p = "(null)";
  80043e:	be 62 10 80 00       	mov    $0x801062,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a96:	00 
  800a97:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800a9e:	00 
  800a9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aa6:	00 
  800aa7:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b28:	00 
  800b29:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800b30:	00 
  800b31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b38:	00 
  800b39:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7b:	00 
  800b7c:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800b83:	00 
  800b84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8b:	00 
  800b8c:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bce:	00 
  800bcf:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800bd6:	00 
  800bd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bde:	00 
  800bdf:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c21:	00 
  800c22:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800c29:	00 
  800c2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c31:	00 
  800c32:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c74:	00 
  800c75:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800c7c:	00 
  800c7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c84:	00 
  800c85:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cc7:	00 
  800cc8:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800ccf:	00 
  800cd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd7:	00 
  800cd8:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
  800cdf:	e8 80 00 00 00       	call   800d64 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3c:	00 
  800d3d:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  800d44:	00 
  800d45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4c:	00 
  800d4d:	c7 04 24 7c 13 80 00 	movl   $0x80137c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d90:	c7 04 24 8c 13 80 00 	movl   $0x80138c,(%esp)
  800d97:	e8 c0 f3 ff ff       	call   80015c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d9c:	89 74 24 04          	mov    %esi,0x4(%esp)
  800da0:	8b 45 10             	mov    0x10(%ebp),%eax
  800da3:	89 04 24             	mov    %eax,(%esp)
  800da6:	e8 50 f3 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800dab:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  800db2:	e8 a5 f3 ff ff       	call   80015c <cprintf>
