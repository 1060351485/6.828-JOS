...
umain(int argc, char **argv)
{
  ...
  800055:	c7 04 24 20 10 80 00 	movl   $0x801020,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e1:	e8 e6 0b 00 00       	call   800dcc <__udivdi3>
  ...
  800234:	e8 b3 0c 00 00       	call   800eec <__umoddi3>
  800239:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80023d:	0f be 80 38 10 80 00 	movsbl 0x801038(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800358:	ff 24 95 80 11 80 00 	jmp    *0x801180(,%edx,4)
  ...
  8003e6:	8b 04 85 e0 12 80 00 	mov    0x8012e0(,%eax,4),%eax
  8003ed:	85 c0                	test   %eax,%eax
  8003ef:	75 23                	jne    800414 <vprintfmt+0x146>
				printfmt(putch, putdat, "error %d", err);
  8003f1:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8003f5:	c7 44 24 08 50 10 80 	movl   $0x801050,0x8(%esp)
  8003fc:	00 
  ...
  800418:	c7 44 24 08 59 10 80 	movl   $0x801059,0x8(%esp)
  80041f:	00 
  ...
  80044c:	75 05                	jne    800453 <vprintfmt+0x185>
				p = "(null)";
  80044e:	be 49 10 80 00       	mov    $0x801049,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aa6:	00 
  800aa7:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800aae:	00 
  800aaf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ab6:	00 
  800ab7:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800abe:	e8 b1 02 00 00       	call   800d74 <_panic>
...
sys_yield(void)
{
  ...
  800af5:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b38:	00 
  800b39:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800b40:	00 
  800b41:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b48:	00 
  800b49:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800b50:	e8 1f 02 00 00       	call   800d74 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8b:	00 
  800b8c:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800b93:	00 
  800b94:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b9b:	00 
  800b9c:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800ba3:	e8 cc 01 00 00       	call   800d74 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bde:	00 
  800bdf:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800be6:	00 
  800be7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bee:	00 
  800bef:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800bf6:	e8 79 01 00 00       	call   800d74 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c31:	00 
  800c32:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800c39:	00 
  800c3a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c41:	00 
  800c42:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800c49:	e8 26 01 00 00       	call   800d74 <_panic>
...
00800c56 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c77:	7e 28                	jle    800ca1 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800c79:	89 44 24 10          	mov    %eax,0x10(%esp)
  800c7d:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800c84:	00 
  800c85:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800c8c:	00 
  800c8d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c94:	00 
  800c95:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cca:	7e 28                	jle    800cf4 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800ccc:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cd0:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800cd7:	00 
  800cd8:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800cdf:	00 
  800ce0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce7:	00 
  800ce8:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800cef:	e8 80 00 00 00       	call   800d74 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3f:	7e 28                	jle    800d69 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d41:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d45:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800d4c:	00 
  800d4d:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  800d54:	00 
  800d55:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5c:	00 
  800d5d:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  800d64:	e8 0b 00 00 00       	call   800d74 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d69:	83 c4 2c             	add    $0x2c,%esp
  800d6c:	5b                   	pop    %ebx
  800d6d:	5e                   	pop    %esi
  800d6e:	5f                   	pop    %edi
  800d6f:	5d                   	pop    %ebp
  800d70:	c3                   	ret    
  800d71:	00 00                	add    %al,(%eax)
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d85:	e8 41 fd ff ff       	call   800acb <sys_getenvid>
  ...
  800da0:	c7 04 24 6c 13 80 00 	movl   $0x80136c,(%esp)
  800da7:	e8 c0 f3 ff ff       	call   80016c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800dac:	89 74 24 04          	mov    %esi,0x4(%esp)
  800db0:	8b 45 10             	mov    0x10(%ebp),%eax
  800db3:	89 04 24             	mov    %eax,(%esp)
  800db6:	e8 50 f3 ff ff       	call   80010b <vcprintf>
	cprintf("\n");
  800dbb:	c7 04 24 2c 10 80 00 	movl   $0x80102c,(%esp)
  800dc2:	e8 a5 f3 ff ff       	call   80016c <cprintf>
