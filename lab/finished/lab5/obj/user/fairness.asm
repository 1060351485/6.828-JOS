...
umain(int argc, char **argv)
{
  ...
  800075:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  800090:	c7 04 24 b1 11 80 00 	movl   $0x8011b1,(%esp)
  ...
  8000bc:	e8 7c 0d 00 00       	call   800e3d <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800241:	e8 02 0d 00 00       	call   800f48 <__udivdi3>
  ...
  800294:	e8 cf 0d 00 00       	call   801068 <__umoddi3>
  800299:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80029d:	0f be 80 d2 11 80 00 	movsbl 0x8011d2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b8:	ff 24 95 20 13 80 00 	jmp    *0x801320(,%edx,4)
  ...
  800446:	8b 04 85 80 14 80 00 	mov    0x801480(,%eax,4),%eax
  80044d:	85 c0                	test   %eax,%eax
  80044f:	75 23                	jne    800474 <vprintfmt+0x146>
				printfmt(putch, putdat, "error %d", err);
  800451:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800455:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80045c:	00 
  ...
  800478:	c7 44 24 08 f3 11 80 	movl   $0x8011f3,0x8(%esp)
  80047f:	00 
  ...
  8004ac:	75 05                	jne    8004b3 <vprintfmt+0x185>
				p = "(null)";
  8004ae:	be e3 11 80 00       	mov    $0x8011e3,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b06:	00 
  800b07:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800b0e:	00 
  800b0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b16:	00 
  800b17:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800b1e:	e8 cd 03 00 00       	call   800ef0 <_panic>
...
sys_yield(void)
{
  ...
  800b55:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b98:	00 
  800b99:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800ba0:	00 
  800ba1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba8:	00 
  800ba9:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800bb0:	e8 3b 03 00 00       	call   800ef0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800beb:	00 
  800bec:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800bf3:	00 
  800bf4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bfb:	00 
  800bfc:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800c03:	e8 e8 02 00 00       	call   800ef0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c3e:	00 
  800c3f:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800c46:	00 
  800c47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c4e:	00 
  800c4f:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800c56:	e8 95 02 00 00       	call   800ef0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c91:	00 
  800c92:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800c99:	00 
  800c9a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca1:	00 
  800ca2:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800ca9:	e8 42 02 00 00       	call   800ef0 <_panic>
...
00800cb6 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cd7:	7e 28                	jle    800d01 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800cd9:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cdd:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800ce4:	00 
  800ce5:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf4:	00 
  800cf5:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800cfc:	e8 ef 01 00 00       	call   800ef0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d2a:	7e 28                	jle    800d54 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800d2c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800d30:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800d37:	00 
  800d38:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800d3f:	00 
  800d40:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d47:	00 
  800d48:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800d4f:	e8 9c 01 00 00       	call   800ef0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d9f:	7e 28                	jle    800dc9 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800da1:	89 44 24 10          	mov    %eax,0x10(%esp)
  800da5:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800dac:	00 
  800dad:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800db4:	00 
  800db5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbc:	00 
  800dbd:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800dc4:	e8 27 01 00 00       	call   800ef0 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800df1:	e8 89 ff ff ff       	call   800d7f <sys_ipc_recv>
	if (from_env_store != NULL)
  800df6:	85 db                	test   %ebx,%ebx
  800df8:	74 0b                	je     800e05 <ipc_recv+0x31>
		*from_env_store = thisenv->env_ipc_from; 
  800dfa:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800e00:	8b 52 74             	mov    0x74(%edx),%edx
  800e03:	89 13                	mov    %edx,(%ebx)
	if (perm_store != NULL)
  800e05:	85 f6                	test   %esi,%esi
  800e07:	74 0b                	je     800e14 <ipc_recv+0x40>
		*perm_store = thisenv->env_ipc_perm;
  800e09:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800e0f:	8b 52 78             	mov    0x78(%edx),%edx
  800e12:	89 16                	mov    %edx,(%esi)
	
	if (r < 0){
  800e14:	85 c0                	test   %eax,%eax
  800e16:	79 16                	jns    800e2e <ipc_recv+0x5a>
		if(from_env_store != NULL)
  800e18:	85 db                	test   %ebx,%ebx
  800e1a:	74 06                	je     800e22 <ipc_recv+0x4e>
			*from_env_store = 0;
  800e1c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		if(perm_store != NULL)	
  800e22:	85 f6                	test   %esi,%esi
  800e24:	74 10                	je     800e36 <ipc_recv+0x62>
			*perm_store = 0;
  800e26:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  800e2c:	eb 08                	jmp    800e36 <ipc_recv+0x62>
		return r;
	}
	
	return thisenv->env_ipc_value;
  800e2e:	a1 04 20 80 00       	mov    0x802004,%eax
  800e33:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e41:	56                   	push   %esi
  800e42:	53                   	push   %ebx
  800e43:	83 ec 1c             	sub    $0x1c,%esp
  800e46:	8b 75 08             	mov    0x8(%ebp),%esi
  800e49:	8b 7d 0c             	mov    0xc(%ebp),%edi
  800e4c:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
	int r;
	while((r = sys_ipc_try_send(to_env, val, pg?pg:(void*)UTOP, perm)) < 0){
  800e4f:	eb 2a                	jmp    800e7b <ipc_send+0x3e>
		if (r != -E_IPC_NOT_RECV)
  800e51:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800e54:	74 20                	je     800e76 <ipc_send+0x39>
			panic("ipc_send: sys_ipc_try_send failed %e", r);
  800e56:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800e5a:	c7 44 24 08 0c 15 80 	movl   $0x80150c,0x8(%esp)
  800e61:	00 
  800e62:	c7 44 24 04 3e 00 00 	movl   $0x3e,0x4(%esp)
  800e69:	00 
  800e6a:	c7 04 24 31 15 80 00 	movl   $0x801531,(%esp)
  800e71:	e8 7a 00 00 00       	call   800ef0 <_panic>
		sys_yield();
  800e76:	e8 cf fc ff ff       	call   800b4a <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
  ...
  800e7d:	75 07                	jne    800e86 <ipc_send+0x49>
  800e7f:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800e84:	eb 02                	jmp    800e88 <ipc_send+0x4b>
  800e86:	89 d8                	mov    %ebx,%eax
  800e88:	8b 55 14             	mov    0x14(%ebp),%edx
  800e8b:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e8f:	89 44 24 08          	mov    %eax,0x8(%esp)
  800e93:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800e97:	89 34 24             	mov    %esi,(%esp)
  800e9a:	e8 bd fe ff ff       	call   800d5c <sys_ipc_try_send>
  800e9f:	85 c0                	test   %eax,%eax
  800ea1:	78 ae                	js     800e51 <ipc_send+0x14>
		if (r != -E_IPC_NOT_RECV)
			panic("ipc_send: sys_ipc_try_send failed %e", r);
		sys_yield();
	}
}
  800ea3:	83 c4 1c             	add    $0x1c,%esp
  800ea6:	5b                   	pop    %ebx
  800ea7:	5e                   	pop    %esi
  800ea8:	5f                   	pop    %edi
  800ea9:	5d                   	pop    %ebp
...
ipc_find_env(enum EnvType type)
{
  ...
  800eb7:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  800ebe:	89 c2                	mov    %eax,%edx
  800ec0:	c1 e2 07             	shl    $0x7,%edx
  800ec3:	29 ca                	sub    %ecx,%edx
  800ec5:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800ecb:	8b 52 50             	mov    0x50(%edx),%edx
  800ece:	39 da                	cmp    %ebx,%edx
  800ed0:	75 0f                	jne    800ee1 <ipc_find_env+0x36>
			return envs[i].env_id;
  800ed2:	c1 e0 07             	shl    $0x7,%eax
  800ed5:	29 c8                	sub    %ecx,%eax
  800ed7:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800edc:	8b 40 40             	mov    0x40(%eax),%eax
  800edf:	eb 0c                	jmp    800eed <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	...
	for (i = 0; i < NENV; i++)
  800ee1:	40                   	inc    %eax
  800ee2:	3d 00 04 00 00       	cmp    $0x400,%eax
  800ee7:	75 ce                	jne    800eb7 <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800ee9:	66 b8 00 00          	mov    $0x0,%ax
}
  800eed:	5b                   	pop    %ebx
  800eee:	5d                   	pop    %ebp
  800eef:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ef5:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800ef8:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800efb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800f01:	e8 25 fc ff ff       	call   800b2b <sys_getenvid>
  800f06:	8b 55 0c             	mov    0xc(%ebp),%edx
  800f09:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f0d:	8b 55 08             	mov    0x8(%ebp),%edx
  800f10:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f14:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f18:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f1c:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800f23:	e8 a4 f2 ff ff       	call   8001cc <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f28:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f2c:	8b 45 10             	mov    0x10(%ebp),%eax
  800f2f:	89 04 24             	mov    %eax,(%esp)
  800f32:	e8 34 f2 ff ff       	call   80016b <vcprintf>
	cprintf("\n");
  800f37:	c7 04 24 af 11 80 00 	movl   $0x8011af,(%esp)
  800f3e:	e8 89 f2 ff ff       	call   8001cc <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f43:	cc                   	int3   
  800f44:	eb fd                	jmp    800f43 <_panic+0x53>
	...
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f4e:	8b 74 24 20          	mov    0x20(%esp),%esi
  800f52:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800f5a:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800f5e:	89 cd                	mov    %ecx,%ebp
  800f60:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800f66:	75 2c                	jne    800f94 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800f68:	39 f9                	cmp    %edi,%ecx
  800f6a:	77 68                	ja     800fd4 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800f6e:	75 0b                	jne    800f7b <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f93:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800f94:	39 f8                	cmp    %edi,%eax
  800f96:	77 2c                	ja     800fc4 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800f98:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800f9b:	83 f6 1f             	xor    $0x1f,%esi
  800f9e:	75 4c                	jne    800fec <__udivdi3+0xa4>
  ...
  800fa2:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800fa7:	72 0a                	jb     800fb3 <__udivdi3+0x6b>
  800fa9:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800fad:	0f 87 ad 00 00 00    	ja     801060 <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800fb3:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800ff0:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800ff9:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800ffb:	89 ea                	mov    %ebp,%edx
  800ffd:	88 c1                	mov    %al,%cl
  800fff:	d3 ea                	shr    %cl,%edx
  801001:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  801005:	09 ca                	or     %ecx,%edx
  801007:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  80100b:	89 f1                	mov    %esi,%ecx
  80100d:	d3 e5                	shl    %cl,%ebp
  80100f:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  801013:	89 fd                	mov    %edi,%ebp
  801015:	88 c1                	mov    %al,%cl
  801017:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  801019:	89 fa                	mov    %edi,%edx
  80101b:	89 f1                	mov    %esi,%ecx
  80101d:	d3 e2                	shl    %cl,%edx
  80101f:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801023:	88 c1                	mov    %al,%cl
  801025:	d3 ef                	shr    %cl,%edi
  801027:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  801029:	89 f8                	mov    %edi,%eax
  80102b:	89 ea                	mov    %ebp,%edx
  80102d:	f7 74 24 08          	divl   0x8(%esp)
  801031:	89 d1                	mov    %edx,%ecx
  801033:	89 c7                	mov    %eax,%edi
	      umul_ppmm (m1, m0, q0, d0);
  801035:	f7 64 24 0c          	mull   0xc(%esp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801039:	39 d1                	cmp    %edx,%ecx
  80103b:	72 17                	jb     801054 <__udivdi3+0x10c>
  80103d:	74 09                	je     801048 <__udivdi3+0x100>
  80103f:	89 fe                	mov    %edi,%esi
  801041:	31 ff                	xor    %edi,%edi
  801043:	e9 41 ff ff ff       	jmp    800f89 <__udivdi3+0x41>
  ...
  801052:	73 eb                	jae    80103f <__udivdi3+0xf7>
		{
		  q0--;
  801054:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  801057:	31 ff                	xor    %edi,%edi
  801059:	e9 2b ff ff ff       	jmp    800f89 <__udivdi3+0x41>
  80105e:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  801060:	31 f6                	xor    %esi,%esi
  801062:	e9 22 ff ff ff       	jmp    800f89 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  80106e:	8b 44 24 30          	mov    0x30(%esp),%eax
  801072:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  801076:	89 44 24 14          	mov    %eax,0x14(%esp)
  80107a:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  80107e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801082:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  80108a:	85 ed                	test   %ebp,%ebp
  80108c:	75 16                	jne    8010a4 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  80108e:	39 f1                	cmp    %esi,%ecx
  801090:	0f 86 a6 00 00 00    	jbe    80113c <__umoddi3+0xd4>
  ...
  8010a3:	90                   	nop
    ...
    {
      if (d1 > n1)
  8010a4:	39 f5                	cmp    %esi,%ebp
  8010a6:	0f 87 ac 00 00 00    	ja     801158 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  8010b6:	0f 84 a8 00 00 00    	je     801164 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  8010bc:	8a 4c 24 10          	mov    0x10(%esp),%cl
  8010c0:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  8010c2:	bf 20 00 00 00       	mov    $0x20,%edi
  8010c7:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  8010cb:	8b 44 24 0c          	mov    0xc(%esp),%eax
  8010cf:	89 f9                	mov    %edi,%ecx
  8010d1:	d3 e8                	shr    %cl,%eax
  8010d3:	09 e8                	or     %ebp,%eax
  8010d5:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  8010d9:	8b 44 24 0c          	mov    0xc(%esp),%eax
  8010dd:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  8010e9:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  8010eb:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010ef:	d3 e0                	shl    %cl,%eax
  8010f1:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  8010f5:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010f9:	89 f9                	mov    %edi,%ecx
  8010fb:	d3 e8                	shr    %cl,%eax
  8010fd:	09 d0                	or     %edx,%eax
  ...
  801103:	f7 74 24 18          	divl   0x18(%esp)
  801107:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801109:	f7 64 24 0c          	mull   0xc(%esp)
  80110d:	89 c5                	mov    %eax,%ebp
  80110f:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801111:	39 d6                	cmp    %edx,%esi
  801113:	72 67                	jb     80117c <__umoddi3+0x114>
  801115:	74 75                	je     80118c <__umoddi3+0x124>
	      q1 = 0;
  ...
  801117:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80111b:	29 e8                	sub    %ebp,%eax
  80111d:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  80111f:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801123:	d3 e8                	shr    %cl,%eax
  801125:	89 f2                	mov    %esi,%edx
  801127:	89 f9                	mov    %edi,%ecx
  801129:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  80112b:	09 d0                	or     %edx,%eax
  ...
  80115f:	5d                   	pop    %ebp
  801160:	c3                   	ret    
  801161:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  801164:	39 f5                	cmp    %esi,%ebp
  801166:	72 04                	jb     80116c <__umoddi3+0x104>
  801168:	39 f9                	cmp    %edi,%ecx
  80116a:	77 06                	ja     801172 <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  80116c:	89 f2                	mov    %esi,%edx
  80116e:	29 cf                	sub    %ecx,%edi
  801170:	19 ea                	sbb    %ebp,%edx
  ...
  80117e:	89 c5                	mov    %eax,%ebp
  801180:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801184:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801188:	eb 8d                	jmp    801117 <__umoddi3+0xaf>
  80118a:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  80118c:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801190:	72 ea                	jb     80117c <__umoddi3+0x114>
  801192:	89 f1                	mov    %esi,%ecx
  801194:	eb 81                	jmp    801117 <__umoddi3+0xaf>
