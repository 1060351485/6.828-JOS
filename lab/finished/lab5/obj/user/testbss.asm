...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800190:	c7 04 24 88 11 80 00 	movl   $0x801188,(%esp)
  ...
  8001a6:	e8 50 00 00 00       	call   8001fb <vcprintf>
	cprintf("\n");
  8001ab:	c7 04 24 56 11 80 00 	movl   $0x801156,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d1:	e8 8e 0b 00 00       	call   800e64 <__udivdi3>
  ...
  800324:	e8 5b 0c 00 00       	call   800f84 <__umoddi3>
  800329:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80032d:	0f be 80 ab 11 80 00 	movsbl 0x8011ab(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004e5:	c7 44 24 08 c3 11 80 	movl   $0x8011c3,0x8(%esp)
  8004ec:	00 
  ...
  800508:	c7 44 24 08 cc 11 80 	movl   $0x8011cc,0x8(%esp)
  80050f:	00 
  ...
  80053c:	75 05                	jne    800543 <vprintfmt+0x185>
				p = "(null)";
  80053e:	be bc 11 80 00       	mov    $0x8011bc,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b96:	00 
  800b97:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800b9e:	00 
  800b9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba6:	00 
  800ba7:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c28:	00 
  800c29:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800c30:	00 
  800c31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c38:	00 
  800c39:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c7b:	00 
  800c7c:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800c83:	00 
  800c84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c8b:	00 
  800c8c:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cce:	00 
  800ccf:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800cd6:	00 
  800cd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cde:	00 
  800cdf:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d21:	00 
  800d22:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800d29:	00 
  800d2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d31:	00 
  800d32:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d74:	00 
  800d75:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800d7c:	00 
  800d7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d84:	00 
  800d85:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dc7:	00 
  800dc8:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800dcf:	00 
  800dd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd7:	00 
  800dd8:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e3c:	00 
  800e3d:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800e44:	00 
  800e45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4c:	00 
  800e4d:	c7 04 24 dd 14 80 00 	movl   $0x8014dd,(%esp)
